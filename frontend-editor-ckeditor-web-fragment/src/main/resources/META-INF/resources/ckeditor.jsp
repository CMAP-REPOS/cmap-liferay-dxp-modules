	...
	var createEditor = function() {
		...
		if (pathThemeImages.indexOf('cmap') > -1) {
			...
			var cmapConfig = {
				...
				format_tags: 'p;h2;h3;h4;h5;h6;div',
				format_h2: { element: 'h2', attributes: { 'class': 'page-headline' } },
				format_h3: { element: 'h3', attributes: { 'class': 'section-headline' } },
				format_h4: { element: 'h4', attributes: { 'class': 'section-sub-headline' } },
				format_h5: { element: 'h5', attributes: { 'class': 'normal-headline' } },
				format_h6: { element: 'h6', attributes: { 'class': 'small-headline' } },
			...
			CKEDITOR.addTemplates( 'cmap', {
				...
				templates: [
					...
					},
					{
						...
						html: '<div class="inline-center-col row"><div class="col-md-4 col-sm-16"></div><div class="col-md-8 col-sm-16"><h5 class="normal-headline">Type your new headline here.</h5><p>The colors will not show up on the live website, they are only there to show where the content goes.</p></div><div class="col-md-4 col-sm-16"></div></div>'
					},
					{
						title: 'Actions',
						image: '',
						description: 'Used to place centered content inside of a full width widget. Generates a grid with the center column at the correct size.',
						html: '<div class="onto2050-actions row"> <div class="col-sm-8"> <h5 class="normal-headline">Revisit parking requirements</h5> <p>Municipalities should prioritize capital projects that enhance pedestrian and bicycle access to transit stations.</p> </div> <div class="col-sm-8"><h5 class="normal-headline">Revisit parking requirements</h5> <p>Municipalities should prioritize capital projects that enhance pedestrian and bicycle access to transit stations.</p></div> </div>'
					},
					{
						title: 'Advertisement',
						image: 'clarknelson.com/drop/Screen-Shot-2018-05-31-15-36-08.png',
						description: 'A widget designed to point to another page. Should contain a picture, headline, description, and button.',
						html: '<div class="advertisement"><div class="row"><div class="col-md-offset-8 col-md-8 col-sm-offset-0 col-sm-12 col-xs-16"><div class="cmap-ad-content"><h6 class="small-headline">Topic</h6><p>Here is where the content will go, you can delete this content or change it. If you wish to change the picture, double click on the bottom of the image.</p><a href="google.com" class="button">Double click to edit</a></div></div></div><img class="background" alt="This is the alt description for the advertisement term" src="https://clarknelson.com/drop/lazaro-advertisement-background.jpg" /><div class="widget-spacer"></div></div>'
					},
					{
						...
						html: '<div class="page-cards"><div class="row"><div class="page-card col-sm-8 col-xs-16"><div class="top"><img src="https://clarknelson.com/drop/Cook_116.jpg" /></div><div class="bottom"><h5 class="normal-headline"><a href="google.com" target="_blank">This is the link text, double click to edit link location. Double click photo to change image.</a></h5></div></div></div></div>'
					},
					{
						title: 'Page Cards (Double)',
						image: '',
						description: 'Similar to previous page cards widget, but contains two blocks side-by-side.',
						html: '<div class="page-cards"><div class="row"><div class="page-card col-sm-8 col-xs-16"><div class="top"><img src="https://clarknelson.com/drop/Cook_116.jpg" /></div><div class="bottom"><h5 class="normal-headline"><a href="google.com" target="_blank">This is the link text, double click to edit link location. Double click photo to change image.</a></h5></div></div><div class="page-card col-sm-8 col-xs-16"><div class="top"><img src="https://clarknelson.com/drop/Cook_116.jpg" /></div><div class="bottom"><h5 class="normal-headline"><a href="google.com" target="_blank">This is the link text, double click to edit link location. Double click photo to change image.</a></h5></div></div></div></div>'
					},
					{
						title: 'Ad Grid (Single)',
						image: '',
						description: 'Similar to advertisement, but in a grid.',
						html: '<div class="ad-grid"><div class="row"> <div class="left advertisement"><div class="col-md-offset-8 col-md-8 col-sm-offset-0 col-sm-12 col-xs-16"><div class="cmap-ad-content"><h5 class="normal-headline">Headline</h5><p>Here is where the content will go, you can delete this content or change it. If you wish to change the picture, double click on the bottom of the image</p><a href="" class="button">View Page</a></div></div><img class="background" alt="This is the alt description for the advertisement term" src="https://clarknelson.com/drop/lazaro-advertisement-background.jpg" /><div class="widget-spacer"></div></div> </div></div>'
					},
					{
						title: 'Ad Grid (Double)',
						image: '',
						description: 'Similar to advertisement, but in a grid.',
						html: '<div class="ad-grid"><div class="row"> <div class="left advertisement"><div class="col-md-offset-8 col-md-8 col-sm-offset-0 col-sm-12 col-xs-16"><div class="cmap-ad-content"><h5 class="normal-headline">Headline</h5><p>Here is where the content will go, you can delete this content or change it. If you wish to change the picture, double click on the bottom of the image.</p><a href="" class="button">View Page</a></div></div><img class="background" alt="This is the alt description for the advertisement term" src="https://clarknelson.com/drop/lazaro-advertisement-background.jpg" /><div class="widget-spacer"></div></div> <div class="right advertisement"><div class="col-md-offset-8 col-md-8 col-sm-offset-0 col-sm-12 col-xs-16"><div class="cmap-ad-content"><h5 class="normal-headline">Headline</h5><p>Here is where the content will go, you can delete this content or change it. If you wish to change the picture, double click on the bottom of the image.</p><a href="" class="button">View Page</a></div></div><img class="background" alt="This is the alt description for the advertisement term" src="https://clarknelson.com/drop/lazaro-advertisement-background.jpg" /><div class="widget-spacer"></div></div></div></div>'
					}
				]
			});
