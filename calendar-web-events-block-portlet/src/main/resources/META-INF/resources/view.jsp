    ...
    <div class="col-xs-16 hidden-md hidden-lg">
        <div class="slider">
            <div class="b-event-list b-event-list--mobile">
                    ...
                    <div class="col-xs-16">
                        <div class="b-event-list__header">
                            <h3>Events
                                <!-- Link to Events page -->
                                <a class="b-event-list__view-all" href="#">View All</a>
	                            	<svg class="svg-calendar" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
										<title>events</title>
										<path d="M27.857,29.5H8.142A1.663,1.663,0,0,1,6.5,27.858V10.608A1.661,1.661,0,0,1,8.142,8.965H9.785v.82A2.455,2.455,0,0,0,12.25,12.25a2.455,2.455,0,0,0,2.464-2.465v-.82h6.571v.82a2.465,2.465,0,1,0,4.929,0v-.82h1.643A1.663,1.663,0,0,1,29.5,10.608v17.25A1.665,1.665,0,0,1,27.857,29.5m0-14.785H8.143V27.857H27.857Zm-4.133-3.286a1.62,1.62,0,0,1-1.617-1.616V8.118a1.617,1.617,0,0,1,3.234,0V9.812a1.62,1.62,0,0,1-1.617,1.616m-11.5,0a1.62,1.62,0,0,1-1.617-1.616V8.118a1.617,1.617,0,0,1,3.234,0V9.812a1.62,1.62,0,0,1-1.617,1.616" fill="#3c5979" />
									  	<text x="18" y="23" dominant-baseline="middle" text-anchor="middle" font-weight="bold" font-size="60%" class="b-event-list__today" fill="#3c5979"></text>
									</svg>
                            	</span>
                            </h3>
                        </div>
                ...
                <div class="b-event-list__list slider-container">
                    <!-- ========= START: Event ITEM ======== -->
                    <c:forEach var="event" items="${events}">
