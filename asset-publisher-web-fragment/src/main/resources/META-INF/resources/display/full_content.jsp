...
Format dateFormat = FastDateFormatFactoryUtil.getSimpleDateFormat("MMMM d, yyyy", locale);
%>

<h3 class="publish-date"><%=dateFormat.format(assetEntry.getPublishDate()) %></h3>
