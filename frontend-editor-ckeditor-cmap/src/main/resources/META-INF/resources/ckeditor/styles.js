if(Object.keys(CKEDITOR.stylesSet.registered).includes('cmap_styles')){
	...
	CKEDITOR.stylesSet.add( 'cmap_styles', [
        ...
        { name: 'Recommendation', element: 'span', attributes: { 'class': 'section-sub-headline recommendation-headline' } },
        { name: 'Goal', element: 'span', attributes: { 'class': 'normal-headline goal-headline' } },
