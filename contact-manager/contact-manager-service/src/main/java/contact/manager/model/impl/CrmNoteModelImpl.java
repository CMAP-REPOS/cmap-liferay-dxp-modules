...
import contact.manager.model.CrmNoteSoap;
...
public class CrmNoteModelImpl extends BaseModelImpl<CrmNote>
	 ...
	 */
	public static CrmNote toModel(CrmNoteSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		CrmNote model = new CrmNoteImpl();

		model.setUuid(soapModel.getUuid());
		model.setCrmNoteId(soapModel.getCrmNoteId());
	 ...
	 */
	public static List<CrmNote> toModels(CrmNoteSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<CrmNote> models = new ArrayList<CrmNote>(soapModels.length);

		for (CrmNoteSoap soapModel : soapModels) {
