...
public class CrmContactModelImpl extends BaseModelImpl<CrmContact>
	...
	public static final String TABLE_SQL_CREATE = "create table crm_contact (uuid_ VARCHAR(75) null,crmContactId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table crm_contact";
	public static final String ORDER_BY_JPQL = " ORDER BY crmContact.crmContactId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY crm_contact.crmContactId ASC";
	...
	public static final long CRMCONTACTID_COLUMN_BITMASK = 8L;
