...
public class CrmChiWardModelImpl extends BaseModelImpl<CrmChiWard>
	...
	public static final String TABLE_SQL_CREATE = "create table crm_chiward (uuid_ VARCHAR(75) null,crmChiWardId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table crm_chiward";
	public static final String ORDER_BY_JPQL = " ORDER BY crmChiWard.crmChiWardId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY crm_chiward.crmChiWardId ASC";
	...
	public static final long CRMCHIWARDID_COLUMN_BITMASK = 8L;
