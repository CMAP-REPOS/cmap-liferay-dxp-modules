...
/**
 * The extended model base implementation for the CrmChiWard service. Represents a row in the &quot;crm_chiward&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CrmChiWardImpl}.
 * </p>
 *
...
public abstract class CrmChiWardBaseImpl
	...
	public void persist() {
		if (this.isNew()) {
			CrmChiWardLocalServiceUtil.addCrmChiWard(this);
		}
		else {
