...
import contact.manager.model.FooModel;
import contact.manager.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(contact.manager.service.util.ServiceProps.get(
				"lock.expiration.time.contact.manager.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("contact.manager.model.Foo");
