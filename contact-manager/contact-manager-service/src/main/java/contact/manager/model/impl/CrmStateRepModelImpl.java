...
import contact.manager.model.CrmStateRepSoap;
...
public class CrmStateRepModelImpl extends BaseModelImpl<CrmStateRep>
	 ...
	 */
	public static CrmStateRep toModel(CrmStateRepSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		CrmStateRep model = new CrmStateRepImpl();

		model.setUuid(soapModel.getUuid());
		model.setCrmStateRepId(soapModel.getCrmStateRepId());
	 ...
	 */
	public static List<CrmStateRep> toModels(CrmStateRepSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<CrmStateRep> models = new ArrayList<CrmStateRep>(soapModels.length);

		for (CrmStateRepSoap soapModel : soapModels) {
