...
/**
 * The extended model base implementation for the CrmLTA service. Represents a row in the &quot;crm_lta&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CrmLTAImpl}.
 * </p>
 *
...
public abstract class CrmLTABaseImpl extends CrmLTAModelImpl implements CrmLTA {
	...
	public void persist() {
		if (this.isNew()) {
			CrmLTALocalServiceUtil.addCrmLTA(this);
		}
		else {
