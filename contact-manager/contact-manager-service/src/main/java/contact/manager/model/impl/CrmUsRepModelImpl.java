...
import contact.manager.model.CrmUsRepSoap;
...
public class CrmUsRepModelImpl extends BaseModelImpl<CrmUsRep>
	 ...
	 */
	public static CrmUsRep toModel(CrmUsRepSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		CrmUsRep model = new CrmUsRepImpl();

		model.setUuid(soapModel.getUuid());
		model.setCrmUsRepId(soapModel.getCrmUsRepId());
	 ...
	 */
	public static List<CrmUsRep> toModels(CrmUsRepSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<CrmUsRep> models = new ArrayList<CrmUsRep>(soapModels.length);

		for (CrmUsRepSoap soapModel : soapModels) {
