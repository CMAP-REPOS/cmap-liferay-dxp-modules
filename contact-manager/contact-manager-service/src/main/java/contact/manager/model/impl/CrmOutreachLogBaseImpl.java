...
/**
 * The extended model base implementation for the CrmOutreachLog service. Represents a row in the &quot;crm_outreachlog&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CrmOutreachLogImpl}.
 * </p>
 *
...
public abstract class CrmOutreachLogBaseImpl extends CrmOutreachLogModelImpl
	...
	public void persist() {
		if (this.isNew()) {
			CrmOutreachLogLocalServiceUtil.addCrmOutreachLog(this);
		}
		else {
