 ...
 *
 * <p>
 * This implementation and its corresponding interface </code>CrmLTAModel</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CrmLTAImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public class CrmLTAModelImpl
	extends BaseModelImpl<CrmLTA> implements CrmLTAModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"crmLTAId", Types.BIGINT},
	...
	public static final String TABLE_SQL_CREATE =
		"create table crm_lta (uuid_ VARCHAR(75) null,crmLTAId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(500) null,zipCode VARCHAR(75) null)";
	...
	public Map<String, Object> getModelAttributes() {
		...
		Map<String, Function<CrmLTA, Object>> attributeGetterFunctions =
			getAttributeGetterFunctions();

		for (Map.Entry<String, Function<CrmLTA, Object>> entry :
				attributeGetterFunctions.entrySet()) {

			String attributeName = entry.getKey();
			Function<CrmLTA, Object> attributeGetterFunction = entry.getValue();

			attributes.put(
				attributeName, attributeGetterFunction.apply((CrmLTA)this));
		}
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Map<String, BiConsumer<CrmLTA, Object>> attributeSetterBiConsumers =
			getAttributeSetterBiConsumers();

		for (Map.Entry<String, Object> entry : attributes.entrySet()) {
			String attributeName = entry.getKey();

			BiConsumer<CrmLTA, Object> attributeSetterBiConsumer =
				attributeSetterBiConsumers.get(attributeName);

			if (attributeSetterBiConsumer != null) {
				attributeSetterBiConsumer.accept(
					(CrmLTA)this, entry.getValue());
			}
		}
	}

	public Map<String, Function<CrmLTA, Object>> getAttributeGetterFunctions() {
		return _attributeGetterFunctions;
	}

	public Map<String, BiConsumer<CrmLTA, Object>>
		getAttributeSetterBiConsumers() {

		return _attributeSetterBiConsumers;
	}

	private static Function<InvocationHandler, CrmLTA>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CrmLTA.class.getClassLoader(), CrmLTA.class, ModelWrapper.class);

		try {
			Constructor<CrmLTA> constructor =
				(Constructor<CrmLTA>)proxyClass.getConstructor(
	...
	private static final Map<String, Function<CrmLTA, Object>>
		_attributeGetterFunctions;
	private static final Map<String, BiConsumer<CrmLTA, Object>>
		_attributeSetterBiConsumers;

	static {
		Map<String, Function<CrmLTA, Object>> attributeGetterFunctions =
			new LinkedHashMap<String, Function<CrmLTA, Object>>();
		Map<String, BiConsumer<CrmLTA, ?>> attributeSetterBiConsumers =
			new LinkedHashMap<String, BiConsumer<CrmLTA, ?>>();

		attributeGetterFunctions.put(
			"uuid",
			new Function<CrmLTA, Object>() {

				@Override
				public Object apply(CrmLTA crmLTA) {
					return crmLTA.getUuid();
				}

			});
		attributeSetterBiConsumers.put(
			"uuid",
			new BiConsumer<CrmLTA, Object>() {

				@Override
				public void accept(CrmLTA crmLTA, Object uuid) {
					crmLTA.setUuid((String)uuid);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object crmLTAId) {
					crmLTA.setCrmLTAId((Long)crmLTAId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object groupId) {
					crmLTA.setGroupId((Long)groupId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object companyId) {
					crmLTA.setCompanyId((Long)companyId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object userId) {
					crmLTA.setUserId((Long)userId);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object userName) {
					crmLTA.setUserName((String)userName);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object createDate) {
					crmLTA.setCreateDate((Date)createDate);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object modifiedDate) {
					crmLTA.setModifiedDate((Date)modifiedDate);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object name) {
					crmLTA.setName((String)name);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<CrmLTA, Object>() {
				...
				@Override
				public void accept(CrmLTA crmLTA, Object zipCode) {
					crmLTA.setZipCode((String)zipCode);
				}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			getCompanyId(), CrmLTA.class.getName(), getPrimaryKey());
	}
	...
	public CrmLTA toEscapedModel() {
		if (_escapedModel == null) {
			Function<InvocationHandler, CrmLTA>
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<CrmLTA, Object>> entry :
			...
			sb.append("=");
			sb.append(attributeGetterFunction.apply((CrmLTA)this));
			sb.append(", ");
		}
	...
	private static class EscapedModelProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, CrmLTA>
