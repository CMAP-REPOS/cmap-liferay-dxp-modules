...
/**
 * Provides the base implementation for the CRM Contact Audit Log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link contact.manager.service.impl.CrmContactAuditLogLocalServiceImpl}.
 * </p>
 *
...
public abstract class CrmContactAuditLogLocalServiceBaseImpl
	...
	public List<CrmContactAuditLog> getCrmContactAuditLogs(int start, int end) {
		return crmContactAuditLogPersistence.findAll(start, end);
	}
	...
	public int getCrmContactAuditLogsCount() {
		return crmContactAuditLogPersistence.countAll();
	}
	 ...
	 */
	public CrmContactAuditLogLocalService getCrmContactAuditLogLocalService() {
	...
	public String getOSGiServiceIdentifier() {
		return CrmContactAuditLogLocalService.class.getName();
	}
