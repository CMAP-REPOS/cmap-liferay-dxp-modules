 ...
 * @see CrmChiWardServiceSoap
 * @see HttpPrincipal
 * @see CrmChiWardServiceUtil
 * @generated
 */
@ProviderType
public class CrmChiWardServiceHttp {
	public static java.util.List<contact.manager.model.CrmChiWard> findByZipCode(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmChiWardServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmChiWard>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmChiWardServiceHttp.class);
