 ...
 * @see CrmStateSenateServiceSoap
 * @see HttpPrincipal
 * @see CrmStateSenateServiceUtil
 * @generated
 */
@ProviderType
public class CrmStateSenateServiceHttp {
	public static java.util.List<contact.manager.model.CrmStateSenate> findByZipCode(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmStateSenateServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmStateSenate>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmStateSenateServiceHttp.class);
