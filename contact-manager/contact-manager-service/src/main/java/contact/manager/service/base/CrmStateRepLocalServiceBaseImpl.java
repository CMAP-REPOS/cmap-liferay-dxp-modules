...
public abstract class CrmStateRepLocalServiceBaseImpl
	...
	implements CrmStateRepLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CrmStateRepLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>contact.manager.service.CrmStateRepLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CrmStateRep.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return crmStateRepPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return crmStateRepPersistence.countWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<CrmStateRep>() {
				...
				public void performAction(CrmStateRep crmStateRep)
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, crmStateRep);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return crmStateRepLocalService.deleteCrmStateRep(
			(CrmStateRep)persistedModel);
	}
	...
	public List<CrmStateRep> getCrmStateRepsByUuidAndCompanyId(
		...
		return crmStateRepPersistence.findByUuid_C(
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"contact.manager.model.CrmStateRep", crmStateRepLocalService);
	}
