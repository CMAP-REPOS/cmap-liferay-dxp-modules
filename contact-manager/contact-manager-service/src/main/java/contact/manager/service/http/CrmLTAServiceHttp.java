 ...
 * @see CrmLTAServiceSoap
 * @see HttpPrincipal
 * @see CrmLTAServiceUtil
 * @generated
 */
@ProviderType
public class CrmLTAServiceHttp {
	public static java.util.List<contact.manager.model.CrmLTA> findByZipCode(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmLTAServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmLTA>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmLTAServiceHttp.class);
