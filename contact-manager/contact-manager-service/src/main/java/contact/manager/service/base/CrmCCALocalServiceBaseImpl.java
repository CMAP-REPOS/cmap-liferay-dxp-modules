 ...
 */
@ProviderType
public abstract class CrmCCALocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CrmCCALocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.CrmCCALocalServiceUtil} to access the CRM CCA local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CrmCCA.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return crmCCAPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CrmCCA>() {
				@Override
	...
	public List<CrmCCA> getCrmCCAsByUuidAndCompanyId(String uuid,
		...
		return crmCCAPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("contact.manager.model.CrmCCA",
			crmCCALocalService);
	}
