...
@Component(immediate = true, property = {
		"resource.name=" + CrmGroupModelPermission.RESOURCE_NAME }, service = ResourcePermissionChecker.class)
public class CrmGroupModelPermission extends BaseResourcePermissionChecker {

	public static final String RESOURCE_NAME = "contact.manager.model.crmgroup";
