 ...
 * @see CrmNoteServiceSoap
 * @see HttpPrincipal
 * @see CrmNoteServiceUtil
 * @generated
 */
@ProviderType
public class CrmNoteServiceHttp {
	public static java.util.List<contact.manager.model.CrmNote> findByCrmContactId(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmNoteServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmNote>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmNoteServiceHttp.class);
