...
import contact.manager.service.CrmChiWardService;
...
/**
 * Provides the base implementation for the CRM Chi Ward remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link contact.manager.service.impl.CrmChiWardServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CrmChiWardServiceBaseImpl extends BaseServiceImpl
	implements CrmChiWardService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.CrmChiWardServiceUtil} to access the CRM Chi Ward remote service.
	 */
	 ...
	 */
	public CrmChiWardService getCrmChiWardService() {
	 ...
	 */
	public void setCrmChiWardService(CrmChiWardService crmChiWardService) {
	...
	public String getOSGiServiceIdentifier() {
		return CrmChiWardService.class.getName();
	}
	...
	@BeanReference(type = CrmChiWardService.class)
	protected CrmChiWardService crmChiWardService;
