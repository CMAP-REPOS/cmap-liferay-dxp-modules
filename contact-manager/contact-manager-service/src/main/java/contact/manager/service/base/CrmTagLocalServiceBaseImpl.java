 ...
 */
@ProviderType
public abstract class CrmTagLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CrmTagLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.CrmTagLocalServiceUtil} to access the CRM Tag local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CrmTag.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return crmTagPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CrmTag>() {
				@Override
	...
	public List<CrmTag> getCrmTagsByUuidAndCompanyId(String uuid,
		...
		return crmTagPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("contact.manager.model.CrmTag",
			crmTagLocalService);
	}
