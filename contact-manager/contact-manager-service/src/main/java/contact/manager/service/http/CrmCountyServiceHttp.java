 ...
 * @see CrmCountyServiceSoap
 * @see HttpPrincipal
 * @see CrmCountyServiceUtil
 * @generated
 */
@ProviderType
public class CrmCountyServiceHttp {
	public static java.util.List<contact.manager.model.CrmCounty> findByZipCode(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmCountyServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmCounty>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmCountyServiceHttp.class);
