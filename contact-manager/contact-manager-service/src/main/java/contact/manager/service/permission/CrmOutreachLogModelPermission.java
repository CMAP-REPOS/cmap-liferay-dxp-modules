...
@Component(immediate = true, property = {
		"resource.name=" + CrmOutreachLogModelPermission.RESOURCE_NAME }, service = ResourcePermissionChecker.class)
public class CrmOutreachLogModelPermission extends BaseResourcePermissionChecker {

	public static final String RESOURCE_NAME = "contact.manager.model.crmoutreachlog";
