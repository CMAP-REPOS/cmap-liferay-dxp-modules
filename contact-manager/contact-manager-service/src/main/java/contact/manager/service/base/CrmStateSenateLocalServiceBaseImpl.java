...
public abstract class CrmStateSenateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CrmStateSenateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.CrmStateSenateLocalServiceUtil} to access the CRM State Senate local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CrmStateSenate.class,
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(crmStateSenateLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CrmStateSenate>() {
				@Override
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return crmStateSenateLocalService.deleteCrmStateSenate((CrmStateSenate)persistedModel);
	}
	...
	public List<CrmStateSenate> getCrmStateSenatesByUuidAndCompanyId(
		...
		return crmStateSenatePersistence.findByUuid_C(uuid, companyId, start,
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("contact.manager.model.CrmStateSenate",
