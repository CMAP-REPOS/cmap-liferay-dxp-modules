 ...
 * @see CrmCountyLocalServiceBaseImpl
 * @see contact.manager.service.CrmCountyLocalServiceUtil
 */
public class CrmCountyLocalServiceImpl extends CrmCountyLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
