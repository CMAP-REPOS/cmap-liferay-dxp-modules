 ...
 * @see CrmCCAServiceSoap
 * @see HttpPrincipal
 * @see CrmCCAServiceUtil
 * @generated
 */
@ProviderType
public class CrmCCAServiceHttp {
	public static java.util.List<contact.manager.model.CrmCCA> findByZipCode(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmCCAServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmCCA>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmCCAServiceHttp.class);
