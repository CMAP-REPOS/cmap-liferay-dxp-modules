 ...
 * @see CrmUsRepServiceSoap
 * @see HttpPrincipal
 * @see CrmUsRepServiceUtil
 * @generated
 */
@ProviderType
public class CrmUsRepServiceHttp {
	public static java.util.List<contact.manager.model.CrmUsRep> findByZipCode(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmUsRepServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmUsRep>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmUsRepServiceHttp.class);
