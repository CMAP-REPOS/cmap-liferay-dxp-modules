 ...
 * @see CrmMuniServiceSoap
 * @see HttpPrincipal
 * @see CrmMuniServiceUtil
 * @generated
 */
@ProviderType
public class CrmMuniServiceHttp {
	public static java.util.List<contact.manager.model.CrmMuni> findByZipCode(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmMuniServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmMuni>)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(CrmMuniServiceHttp.class);
