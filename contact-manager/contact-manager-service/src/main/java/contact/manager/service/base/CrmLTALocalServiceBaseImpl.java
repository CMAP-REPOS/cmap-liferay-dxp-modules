 ...
 */
@ProviderType
public abstract class CrmLTALocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CrmLTALocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>contact.manager.service.CrmLTALocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CrmLTA.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return crmLTAPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return crmLTAPersistence.countWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<CrmLTA>() {
	...
	public List<CrmLTA> getCrmLTAsByUuidAndCompanyId(
		...
		return crmLTAPersistence.findByUuid_C(
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"contact.manager.model.CrmLTA", crmLTALocalService);
	}
