 ...
 * @see CrmNoteLocalServiceBaseImpl
 * @see contact.manager.service.CrmNoteLocalServiceUtil
 */
public class CrmNoteLocalServiceImpl extends CrmNoteLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
