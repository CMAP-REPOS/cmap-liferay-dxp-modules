 ...
 * @see CrmOutreachLogServiceSoap
 * @see HttpPrincipal
 * @see CrmOutreachLogServiceUtil
 * @generated
 */
@ProviderType
public class CrmOutreachLogServiceHttp {
	public static java.util.List<contact.manager.model.CrmOutreachLog> findByCrmContactId(
		...
		try {
			MethodKey methodKey = new MethodKey(CrmOutreachLogServiceUtil.class,
			...
			return (java.util.List<contact.manager.model.CrmOutreachLog>)returnObj;
		}
	...
	public static int countByCrmContactIdId(HttpPrincipal httpPrincipal,
		long crmContactId) {
		try {
			MethodKey methodKey = new MethodKey(CrmOutreachLogServiceUtil.class,
					"countByCrmContactIdId",
					_countByCrmContactIdIdParameterTypes3);
	...
	private static Log _log = LogFactoryUtil.getLog(CrmOutreachLogServiceHttp.class);
	...
	private static final Class<?>[] _countByCrmContactIdIdParameterTypes3 = new Class[] {
			long.class
		};
}