...
/**
 * The base model interface for the CrmTag service. Represents a row in the &quot;crm_tag&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>contact.manager.model.impl.CrmTagModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>contact.manager.model.impl.CrmTagImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CrmTagModel
	extends BaseModel<CrmTag>, GroupedModel, ShardedModel, StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a CRM Tag model instance should use the {@link CrmTag} interface instead.
	 */
