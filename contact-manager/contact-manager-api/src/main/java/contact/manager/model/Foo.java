 ...
 * @see FooModel
 * @see contact.manager.model.impl.FooImpl
 * @see contact.manager.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("contact.manager.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link contact.manager.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
