...
/**
 * The base model interface for the CrmCountyCommissioner service. Represents a row in the &quot;crm_countycommissioner&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>contact.manager.model.impl.CrmCountyCommissionerModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>contact.manager.model.impl.CrmCountyCommissionerImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CrmCountyCommissionerModel
	extends BaseModel<CrmCountyCommissioner>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a CRM County Commissioner model instance should use the {@link CrmCountyCommissioner} interface instead.
	 */
	...
	@Override
	public CacheModel<contact.manager.model.CrmCountyCommissioner>
		toCacheModel();
