...
/**
 * The base model interface for the CrmMuni service. Represents a row in the &quot;crm_muni&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link contact.manager.model.impl.CrmMuniModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link contact.manager.model.impl.CrmMuniImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface CrmMuniModel extends BaseModel<CrmMuni>, GroupedModel,
	ShardedModel, StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a CRM Muni model instance should use the {@link CrmMuni} interface instead.
	 */
