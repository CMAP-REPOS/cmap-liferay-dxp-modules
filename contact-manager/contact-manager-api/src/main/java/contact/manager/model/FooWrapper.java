...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<contact.manager.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public contact.manager.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public contact.manager.model.Foo toUnescapedModel() {
		return new FooWrapper(_foo.toUnescapedModel());
	}

	@Override
	public int compareTo(contact.manager.model.Foo foo) {
