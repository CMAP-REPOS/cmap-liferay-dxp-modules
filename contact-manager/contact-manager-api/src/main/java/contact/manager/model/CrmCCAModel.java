 ...
 *
 * <p>
 * This interface and its corresponding implementation <code>contact.manager.model.impl.CrmCCAModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>contact.manager.model.impl.CrmCCAImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CrmCCAModel
	extends BaseModel<CrmCCA>, GroupedModel, ShardedModel, StagedAuditedModel {
	...
	@Override
	public CacheModel<contact.manager.model.CrmCCA> toCacheModel();
