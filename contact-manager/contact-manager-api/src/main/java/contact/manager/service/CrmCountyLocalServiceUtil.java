 ...
 * {@link contact.manager.service.impl.CrmCountyLocalServiceImpl} and is the
 ...
 * @see contact.manager.service.base.CrmCountyLocalServiceBaseImpl
 * @see contact.manager.service.impl.CrmCountyLocalServiceImpl
 * @generated
 */
@ProviderType
public class CrmCountyLocalServiceUtil {
	...
	*/
	public static java.util.List<contact.manager.model.CrmCounty> getCrmCounties(
		int start, int end) {
