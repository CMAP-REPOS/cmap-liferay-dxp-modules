 ...
 * <code>contact.manager.service.impl.CrmMuniLocalServiceImpl</code> and
...
public class CrmMuniLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmMuniLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmMuni>
		getCrmMunisByUuidAndCompanyId(String uuid, long companyId) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmMuni>
		getCrmMunisByUuidAndCompanyId(
			String uuid, long companyId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmMuni> orderByComparator) {

		return getService().getCrmMunisByUuidAndCompanyId(
	...
	private static ServiceTracker<CrmMuniLocalService, CrmMuniLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmMuniLocalService.class);

		ServiceTracker<CrmMuniLocalService, CrmMuniLocalService>
			serviceTracker =
				new ServiceTracker<CrmMuniLocalService, CrmMuniLocalService>(
					bundle.getBundleContext(), CrmMuniLocalService.class, null);
