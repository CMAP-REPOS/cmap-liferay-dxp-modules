...
/**
 * The persistence utility for the CRM Contact Audit Log service. This utility wraps <code>contact.manager.service.persistence.impl.CrmContactAuditLogPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CrmContactAuditLogUtil {
	 ...
	 */
	public static Map<Serializable, CrmContactAuditLog> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CrmContactAuditLog> findByUuid(String uuid) {
	 ...
	 */
	public static List<CrmContactAuditLog> findByUuid(
	 ...
	 */
	public static CrmContactAuditLog findByUuid_First(
			String uuid,
			OrderByComparator<CrmContactAuditLog> orderByComparator)
	 ...
	 */
	public static CrmContactAuditLog fetchByUuid_First(
	 ...
	 * @throws NoSuchCrmContactAuditLogException if a matching CRM Contact Audit Log could not be found
	 */
	public static CrmContactAuditLog findByUuid_Last(
			String uuid,
			OrderByComparator<CrmContactAuditLog> orderByComparator)
		throws contact.manager.exception.NoSuchCrmContactAuditLogException {
	 ...
	 */
	public static CrmContactAuditLog fetchByUuid_Last(
		String uuid, OrderByComparator<CrmContactAuditLog> orderByComparator) {
	...
	public static CrmContactAuditLog[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			crmContactAuditLogId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchCrmContactAuditLogException if a matching CRM Contact Audit Log could not be found
	 */
	public static CrmContactAuditLog findByUUID_G(String uuid, long groupId)
		throws contact.manager.exception.NoSuchCrmContactAuditLogException {
	 ...
	 */
	@Deprecated
	public static CrmContactAuditLog fetchByUUID_G(
	 ...
	 * @return the matching CRM Contact Audit Log, or <code>null</code> if a matching CRM Contact Audit Log could not be found
	 */
	public static CrmContactAuditLog fetchByUUID_G(String uuid, long groupId) {
	 ...
	 */
	public static CrmContactAuditLog removeByUUID_G(String uuid, long groupId)
		throws contact.manager.exception.NoSuchCrmContactAuditLogException {
	 ...
	 * @return the matching CRM Contact Audit Logs
	 */
	public static List<CrmContactAuditLog> findByUuid_C(
	 ...
	 * @throws NoSuchCrmContactAuditLogException if a matching CRM Contact Audit Log could not be found
	 */
	public static CrmContactAuditLog findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<CrmContactAuditLog> orderByComparator)
		throws contact.manager.exception.NoSuchCrmContactAuditLogException {
	 ...
	 * @throws NoSuchCrmContactAuditLogException if a matching CRM Contact Audit Log could not be found
	 */
	public static CrmContactAuditLog findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<CrmContactAuditLog> orderByComparator)
		throws contact.manager.exception.NoSuchCrmContactAuditLogException {
	 ...
	 * @return the last matching CRM Contact Audit Log, or <code>null</code> if a matching CRM Contact Audit Log could not be found
	 */
	public static CrmContactAuditLog fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<CrmContactAuditLog> orderByComparator) {
	...
	public static CrmContactAuditLog[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			crmContactAuditLogId, uuid, companyId, orderByComparator);
	}
	...
	public static CrmContactAuditLog[] findByCrmContactId_PrevAndNext(
		...
		return getPersistence().findByCrmContactId_PrevAndNext(
			crmContactAuditLogId, crmContactId, orderByComparator);
	}
	...
	public static List<CrmContactAuditLog> findByConstantContactId(
		...
		return getPersistence().findByConstantContactId(
			constantContactId, start, end);
	}
	...
	public static List<CrmContactAuditLog> findByConstantContactId(
		...
		return getPersistence().findByConstantContactId(
			constantContactId, start, end, orderByComparator, useFinderCache);
	}
	...
	public static CrmContactAuditLog findByConstantContactId_First(
		...
		return getPersistence().findByConstantContactId_First(
	...
	public static CrmContactAuditLog fetchByConstantContactId_First(
		...
		return getPersistence().fetchByConstantContactId_First(
			constantContactId, orderByComparator);
	}
	...
	public static CrmContactAuditLog findByConstantContactId_Last(
		...
		return getPersistence().findByConstantContactId_Last(
			constantContactId, orderByComparator);
	}
	...
	public static CrmContactAuditLog fetchByConstantContactId_Last(
		...
		return getPersistence().fetchByConstantContactId_Last(
			constantContactId, orderByComparator);
	}
	...
	public static CrmContactAuditLog[] findByConstantContactId_PrevAndNext(
		...
		return getPersistence().findByConstantContactId_PrevAndNext(
			crmContactAuditLogId, constantContactId, orderByComparator);
	}
	...
	public static void cacheResult(
		List<CrmContactAuditLog> crmContactAuditLogs) {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CrmContactAuditLogPersistence.class);

		ServiceTracker
			<CrmContactAuditLogPersistence, CrmContactAuditLogPersistence>
				serviceTracker =
					new ServiceTracker
						<CrmContactAuditLogPersistence,
						 CrmContactAuditLogPersistence>(
							 bundle.getBundleContext(),
							 CrmContactAuditLogPersistence.class, null);
