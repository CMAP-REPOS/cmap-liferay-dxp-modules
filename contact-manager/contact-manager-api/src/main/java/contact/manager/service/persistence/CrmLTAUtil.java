...
/**
 * The persistence utility for the CRM LTA service. This utility wraps {@link contact.manager.service.persistence.impl.CrmLTAPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CrmLTAUtil {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, CrmLTA> fetchByPrimaryKeys(
