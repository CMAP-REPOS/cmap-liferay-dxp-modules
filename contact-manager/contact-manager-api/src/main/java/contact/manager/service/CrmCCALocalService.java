...
/**
 * Provides the local service interface for CrmCCA. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrmCCALocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CrmCCALocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmCCALocalServiceUtil} to access the CRM CCA local service. Add custom service methods to <code>contact.manager.service.impl.CrmCCALocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CrmCCA addCrmCCA(CrmCCA crmCCA);
	...
	public CrmCCA deleteCrmCCA(CrmCCA crmCCA);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmCCA> getCrmCCAs(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmCCA> getCrmCCAsByUuidAndCompanyId(
