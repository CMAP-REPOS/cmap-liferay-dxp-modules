 ...
 */
@ProviderType
public class CrmContactLocalServiceWrapper
	implements CrmContactLocalService, ServiceWrapper<CrmContactLocalService> {
	...
	public contact.manager.model.CrmContact addCrmContact(
		...
		return _crmContactLocalService.addCrmContact(
			crmContact, serviceContext);
	}

	@Override
	public void addCrmGroupCrmContact(
		long crmGroupId, contact.manager.model.CrmContact crmContact) {
	...
	public void addCrmGroupCrmContacts(long crmGroupId, long[] crmContactIds) {
		_crmContactLocalService.addCrmGroupCrmContacts(
			crmGroupId, crmContactIds);
	}

	@Override
	public void addCrmTagCrmContact(
		long crmTagId, contact.manager.model.CrmContact crmContact) {
	 ...
	 */
	@Override
	public contact.manager.model.CrmContact createCrmContact(
		long crmContactId) {
	...
	public contact.manager.model.CrmContact deleteCrmContact(
		...
		return _crmContactLocalService.deleteCrmContact(
			crmContactId, serviceContext);
	}
	...
	public void deleteCrmGroupCrmContact(
		...
		_crmContactLocalService.deleteCrmGroupCrmContact(
			crmGroupId, crmContact);
	}

	@Override
	public void deleteCrmGroupCrmContact(long crmGroupId, long crmContactId) {
		_crmContactLocalService.deleteCrmGroupCrmContact(
			crmGroupId, crmContactId);
	}
	...
	public void deleteCrmGroupCrmContacts(
		...
		_crmContactLocalService.deleteCrmGroupCrmContacts(
			crmGroupId, crmContacts);
	}
	...
	@Override
	public void deleteCrmTagCrmContact(
		long crmTagId, contact.manager.model.CrmContact crmContact) {
	...
	public void deleteCrmTagCrmContacts(long crmTagId, long[] crmContactIds) {
		_crmContactLocalService.deleteCrmTagCrmContacts(
			crmTagId, crmContactIds);
	}
	...
	public long dynamicQueryCount(
		...
		return _crmContactLocalService.dynamicQueryCount(
	...
	public contact.manager.model.CrmContact fetchCrmContactByUuidAndGroupId(
		...
		return _crmContactLocalService.fetchCrmContactByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public contact.manager.model.CrmContact findByConstantContactId(
		...
		return _crmContactLocalService.findByConstantContactId(
			constantContactId);
	}

	@Override
	public java.util.List<contact.manager.model.CrmContact>
			findByPrimaryEmailAddress(String primaryEmailAddress)
		throws com.liferay.portal.kernel.exception.SystemException {

		return _crmContactLocalService.findByPrimaryEmailAddress(
			primaryEmailAddress);
	}
	...
	public java.util.List<contact.manager.model.CrmContact>
		...
		return _crmContactLocalService.findByPrimaryEmailAddressAndStatus(
	...
	public contact.manager.model.CrmContact getCrmContactByUuidAndGroupId(
		...
		return _crmContactLocalService.getCrmContactByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public java.util.List<contact.manager.model.CrmContact>
		...
		return _crmContactLocalService.getCrmContactsByStatus(
	...
	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmContactsByUuidAndCompanyId(String uuid, long companyId) {

		return _crmContactLocalService.getCrmContactsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmContactsByUuidAndCompanyId(
			String uuid, long companyId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmContact> orderByComparator) {
	...
	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmGroupCrmContacts(long crmGroupId) {
	...
	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmGroupCrmContacts(long crmGroupId, int start, int end) {

		return _crmContactLocalService.getCrmGroupCrmContacts(
			crmGroupId, start, end);
	}

	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmGroupCrmContacts(
	...
	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmTagCrmContacts(long crmTagId) {
	...
	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmTagCrmContacts(long crmTagId, int start, int end) {

		return _crmContactLocalService.getCrmTagCrmContacts(
			crmTagId, start, end);
	}

	@Override
	public java.util.List<contact.manager.model.CrmContact>
		getCrmTagCrmContacts(
			long crmTagId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmContact> orderByComparator) {

		return _crmContactLocalService.getCrmTagCrmContacts(
			crmTagId, start, end, orderByComparator);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _crmContactLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
	...
	public boolean hasCrmGroupCrmContact(long crmGroupId, long crmContactId) {
		return _crmContactLocalService.hasCrmGroupCrmContact(
			crmGroupId, crmContactId);
	}
	...
	public boolean hasCrmTagCrmContact(long crmTagId, long crmContactId) {
		return _crmContactLocalService.hasCrmTagCrmContact(
			crmTagId, crmContactId);
	}
	...
	public void initCrmContactResourcePermissions(
		...
		_crmContactLocalService.initCrmContactResourcePermissions(
			serviceContext);
	}

	@Override
	public void setCrmGroupCrmContacts(long crmGroupId, long[] crmContactIds) {
		_crmContactLocalService.setCrmGroupCrmContacts(
			crmGroupId, crmContactIds);
	}
	...
	public contact.manager.model.CrmContact updateCrmContact(
		...
		return _crmContactLocalService.updateCrmContact(
			crmContact, serviceContext);
	}
