...
/**
 * Provides the local service interface for CrmMuni. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrmMuniLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CrmMuniLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmMuniLocalServiceUtil} to access the CRM Muni local service. Add custom service methods to <code>contact.manager.service.impl.CrmMuniLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CrmMuni addCrmMuni(CrmMuni crmMuni);
	...
	public CrmMuni deleteCrmMuni(CrmMuni crmMuni);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmMuni> getCrmMunis(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmMuni> getCrmMunisByUuidAndCompanyId(
