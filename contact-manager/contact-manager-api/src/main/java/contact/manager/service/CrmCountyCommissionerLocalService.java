...
/**
 * Provides the local service interface for CrmCountyCommissioner. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrmCountyCommissionerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CrmCountyCommissionerLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmCountyCommissionerLocalServiceUtil} to access the CRM County Commissioner local service. Add custom service methods to <code>contact.manager.service.impl.CrmCountyCommissionerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CrmCountyCommissioner addCrmCountyCommissioner(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmCountyCommissioner> getCrmCountyCommissioners(
		int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmCountyCommissioner>
