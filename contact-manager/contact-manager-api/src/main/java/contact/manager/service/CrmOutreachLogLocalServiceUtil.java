 ...
 * <code>contact.manager.service.impl.CrmOutreachLogLocalServiceImpl</code> and
...
public class CrmOutreachLogLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmOutreachLogLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static contact.manager.model.CrmOutreachLog
	...
	public static java.util.List<contact.manager.model.CrmOutreachLog>
	...
	public static java.util.List<contact.manager.model.CrmOutreachLog>
		...
		return getService().getCrmOutreachLogsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CrmOutreachLogLocalService.class);

		ServiceTracker<CrmOutreachLogLocalService, CrmOutreachLogLocalService>
			serviceTracker =
				new ServiceTracker
					<CrmOutreachLogLocalService, CrmOutreachLogLocalService>(
