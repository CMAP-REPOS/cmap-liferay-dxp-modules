...
/**
 * Provides the local service interface for CrmKioskContact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrmKioskContactLocalServiceUtil
...
public interface CrmKioskContactLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmKioskContactLocalServiceUtil} to access the CRM Kiosk Contact local service. Add custom service methods to {@link contact.manager.service.impl.CrmKioskContactLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CrmKioskContact addCrmKioskContact(CrmKioskContact crmKioskContact);
	...
	*/
	public CrmKioskContact createCrmKioskContact(long crmKioskContactId);
	...
	*/
	...
	public CrmKioskContact deleteCrmKioskContact(
		CrmKioskContact crmKioskContact);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CrmKioskContact deleteCrmKioskContact(long crmKioskContactId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrmKioskContact fetchCrmKioskContact(long crmKioskContactId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrmKioskContact fetchCrmKioskContactByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrmKioskContact getCrmKioskContact(long crmKioskContactId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrmKioskContact getCrmKioskContactByUuidAndGroupId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CrmKioskContact updateCrmKioskContact(
		CrmKioskContact crmKioskContact);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmKioskContact> getCrmKioskContacts(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmKioskContact> getCrmKioskContactsByUuidAndCompanyId(
