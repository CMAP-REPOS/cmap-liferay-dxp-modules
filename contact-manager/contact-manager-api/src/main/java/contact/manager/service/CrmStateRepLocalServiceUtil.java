 ...
 * <code>contact.manager.service.impl.CrmStateRepLocalServiceImpl</code> and
...
public class CrmStateRepLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmStateRepLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static contact.manager.model.CrmStateRep
		fetchCrmStateRepByUuidAndGroupId(String uuid, long groupId) {

		return getService().fetchCrmStateRepByUuidAndGroupId(uuid, groupId);
	}

	public static java.util.List<contact.manager.model.CrmStateRep>
	 ...
	 */
	public static contact.manager.model.CrmStateRep
			getCrmStateRepByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmStateRep>
		getCrmStateReps(int start, int end) {
	...
	public static java.util.List<contact.manager.model.CrmStateRep>
		...
		return getService().getCrmStateRepsByUuidAndCompanyId(
	...
	private static ServiceTracker
		<CrmStateRepLocalService, CrmStateRepLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmStateRepLocalService.class);

		ServiceTracker<CrmStateRepLocalService, CrmStateRepLocalService>
			serviceTracker =
				new ServiceTracker
					<CrmStateRepLocalService, CrmStateRepLocalService>(
						bundle.getBundleContext(),
						CrmStateRepLocalService.class, null);
