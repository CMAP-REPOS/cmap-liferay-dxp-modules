...
public interface CrmLTALocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmLTALocalServiceUtil} to access the CRM LTA local service. Add custom service methods to <code>contact.manager.service.impl.CrmLTALocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmLTA> getCrmLTAsByUuidAndCompanyId(
