 ...
 * <code>contact.manager.service.impl.CrmCCALocalServiceImpl</code> and
...
public class CrmCCALocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmCCALocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmCCA>
		getCrmCCAsByUuidAndCompanyId(String uuid, long companyId) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmCCA>
		getCrmCCAsByUuidAndCompanyId(
			String uuid, long companyId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmCCA> orderByComparator) {

		return getService().getCrmCCAsByUuidAndCompanyId(
	...
	private static ServiceTracker<CrmCCALocalService, CrmCCALocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmCCALocalService.class);

		ServiceTracker<CrmCCALocalService, CrmCCALocalService> serviceTracker =
			new ServiceTracker<CrmCCALocalService, CrmCCALocalService>(
				bundle.getBundleContext(), CrmCCALocalService.class, null);
