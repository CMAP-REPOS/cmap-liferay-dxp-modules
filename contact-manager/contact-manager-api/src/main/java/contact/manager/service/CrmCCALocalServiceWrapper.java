 ...
 */
@ProviderType
public class CrmCCALocalServiceWrapper
	implements CrmCCALocalService, ServiceWrapper<CrmCCALocalService> {
	 ...
	 */
	@Override
	public java.util.List<contact.manager.model.CrmCCA> getCrmCCAs(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<contact.manager.model.CrmCCA>
		getCrmCCAsByUuidAndCompanyId(String uuid, long companyId) {

		return _crmCCALocalService.getCrmCCAsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _crmCCALocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
