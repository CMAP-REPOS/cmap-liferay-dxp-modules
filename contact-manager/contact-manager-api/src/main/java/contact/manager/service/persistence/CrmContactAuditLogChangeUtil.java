...
public class CrmContactAuditLogChangeUtil {
	...
	public static CrmContactAuditLogChange update(
		...
		return getPersistence().update(crmContactAuditLogChange, serviceContext);
	}
	...
	*/
	public static CrmContactAuditLogChange[] findByUuid_PrevAndNext(
		...
		throws contact.manager.exception.NoSuchCrmContactAuditLogChangeException {
		return getPersistence()
				   .findByUuid_PrevAndNext(crmContactAuditLogChangeId, uuid,
			orderByComparator);
	}
	...
	*/
	public static CrmContactAuditLogChange[] findByUuid_C_PrevAndNext(
		...
		throws contact.manager.exception.NoSuchCrmContactAuditLogChangeException {
		return getPersistence()
				   .findByUuid_C_PrevAndNext(crmContactAuditLogChangeId, uuid,
	...
	*/
	public static List<CrmContactAuditLogChange> findByCrmContactAuditLogId(
		...
		return getPersistence().findByCrmContactAuditLogId(crmContactAuditLogId);
	}
	...
	*/
	public static CrmContactAuditLogChange findByCrmContactAuditLogId_First(
		...
		throws contact.manager.exception.NoSuchCrmContactAuditLogChangeException {
		return getPersistence()
				   .findByCrmContactAuditLogId_First(crmContactAuditLogId,
			orderByComparator);
	}
	...
	*/
	public static CrmContactAuditLogChange fetchByCrmContactAuditLogId_First(
		...
		OrderByComparator<CrmContactAuditLogChange> orderByComparator) {
		return getPersistence()
				   .fetchByCrmContactAuditLogId_First(crmContactAuditLogId,
			orderByComparator);
	}
	...
	*/
	public static CrmContactAuditLogChange findByCrmContactAuditLogId_Last(
		...
		throws contact.manager.exception.NoSuchCrmContactAuditLogChangeException {
		return getPersistence()
				   .findByCrmContactAuditLogId_Last(crmContactAuditLogId,
			orderByComparator);
	}
	...
	*/
	public static CrmContactAuditLogChange fetchByCrmContactAuditLogId_Last(
		...
		OrderByComparator<CrmContactAuditLogChange> orderByComparator) {
		return getPersistence()
				   .fetchByCrmContactAuditLogId_Last(crmContactAuditLogId,
			orderByComparator);
	}
	...
	* @throws NoSuchCrmContactAuditLogChangeException if a CRM Contact Audit Log Change with the primary key could not be found
	*/
	public static CrmContactAuditLogChange[] findByCrmContactAuditLogId_PrevAndNext(
		long crmContactAuditLogChangeId, long crmContactAuditLogId,
		OrderByComparator<CrmContactAuditLogChange> orderByComparator)
		throws contact.manager.exception.NoSuchCrmContactAuditLogChangeException {
		return getPersistence()
				   .findByCrmContactAuditLogId_PrevAndNext(crmContactAuditLogChangeId,
	...
	*/
	public static int countByCrmContactAuditLogId(long crmContactAuditLogId) {
		return getPersistence().countByCrmContactAuditLogId(crmContactAuditLogId);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, CrmContactAuditLogChange> fetchByPrimaryKeys(
