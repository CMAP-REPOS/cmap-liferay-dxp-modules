...
/**
 * Provides the remote service utility for CrmContactAuditLogChange. This utility wraps
 * {@link contact.manager.service.impl.CrmContactAuditLogChangeServiceImpl} and is the
 ...
 */
@ProviderType
public class CrmContactAuditLogChangeServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link contact.manager.service.impl.CrmContactAuditLogChangeServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static CrmContactAuditLogChangeService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<CrmContactAuditLogChangeService, CrmContactAuditLogChangeService> _serviceTracker =
		ServiceTrackerFactory.open(CrmContactAuditLogChangeService.class);
}