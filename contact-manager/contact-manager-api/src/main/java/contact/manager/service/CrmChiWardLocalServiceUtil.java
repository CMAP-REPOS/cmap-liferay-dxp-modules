 ...
 * <code>contact.manager.service.impl.CrmChiWardLocalServiceImpl</code> and
...
public class CrmChiWardLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmChiWardLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static contact.manager.model.CrmChiWard
		fetchCrmChiWardByUuidAndGroupId(String uuid, long groupId) {

		return getService().fetchCrmChiWardByUuidAndGroupId(uuid, groupId);
	}

	public static java.util.List<contact.manager.model.CrmChiWard>
	 ...
	 */
	public static contact.manager.model.CrmChiWard
			getCrmChiWardByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmChiWard>
		getCrmChiWards(int start, int end) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmChiWard>
		getCrmChiWardsByUuidAndCompanyId(String uuid, long companyId) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmChiWard>
		getCrmChiWardsByUuidAndCompanyId(
			String uuid, long companyId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmChiWard> orderByComparator) {

		return getService().getCrmChiWardsByUuidAndCompanyId(
	...
	private static ServiceTracker
		<CrmChiWardLocalService, CrmChiWardLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmChiWardLocalService.class);

		ServiceTracker<CrmChiWardLocalService, CrmChiWardLocalService>
			serviceTracker =
				new ServiceTracker
					<CrmChiWardLocalService, CrmChiWardLocalService>(
						bundle.getBundleContext(), CrmChiWardLocalService.class,
						null);
