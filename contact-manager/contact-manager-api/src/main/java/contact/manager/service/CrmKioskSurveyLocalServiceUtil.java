...
/**
 * Provides the local service utility for CrmKioskSurvey. This utility wraps
 * {@link contact.manager.service.impl.CrmKioskSurveyLocalServiceImpl} and is the
 ...
 * @see contact.manager.service.base.CrmKioskSurveyLocalServiceBaseImpl
 * @see contact.manager.service.impl.CrmKioskSurveyLocalServiceImpl
 * @generated
 */
@ProviderType
public class CrmKioskSurveyLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link contact.manager.service.impl.CrmKioskSurveyLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static contact.manager.model.CrmKioskSurvey addCrmKioskSurvey(
		contact.manager.model.CrmKioskSurvey crmKioskSurvey) {
		return getService().addCrmKioskSurvey(crmKioskSurvey);
	}
	...
	*/
	public static contact.manager.model.CrmKioskSurvey createCrmKioskSurvey(
		long crmKioskSurveyId) {
		return getService().createCrmKioskSurvey(crmKioskSurveyId);
	}
	...
	*/
	public static contact.manager.model.CrmKioskSurvey deleteCrmKioskSurvey(
		contact.manager.model.CrmKioskSurvey crmKioskSurvey) {
		return getService().deleteCrmKioskSurvey(crmKioskSurvey);
	}
	...
	*/
	public static contact.manager.model.CrmKioskSurvey deleteCrmKioskSurvey(
		long crmKioskSurveyId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteCrmKioskSurvey(crmKioskSurveyId);
	}

	public static contact.manager.model.CrmKioskSurvey fetchCrmKioskSurvey(
		long crmKioskSurveyId) {
		return getService().fetchCrmKioskSurvey(crmKioskSurveyId);
	}
	...
	*/
	public static contact.manager.model.CrmKioskSurvey fetchCrmKioskSurveyByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService().fetchCrmKioskSurveyByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a CRM Kiosk Survey with the primary key could not be found
	*/
	public static contact.manager.model.CrmKioskSurvey getCrmKioskSurvey(
		long crmKioskSurveyId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getCrmKioskSurvey(crmKioskSurveyId);
	}
	...
	*/
	public static contact.manager.model.CrmKioskSurvey getCrmKioskSurveyByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getCrmKioskSurveyByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static contact.manager.model.CrmKioskSurvey updateCrmKioskSurvey(
		contact.manager.model.CrmKioskSurvey crmKioskSurvey) {
		return getService().updateCrmKioskSurvey(crmKioskSurvey);
	}
	...
	*/
	public static int getCrmKioskSurveiesCount() {
		return getService().getCrmKioskSurveiesCount();
	}
	...
	*/
	public static java.util.List<contact.manager.model.CrmKioskSurvey> getCrmKioskSurveies(
		int start, int end) {
		return getService().getCrmKioskSurveies(start, end);
	}
	...
	*/
	public static java.util.List<contact.manager.model.CrmKioskSurvey> getCrmKioskSurveiesByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService()
				   .getCrmKioskSurveiesByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	...
	public static CrmKioskSurveyLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<CrmKioskSurveyLocalService, CrmKioskSurveyLocalService> _serviceTracker =
		ServiceTrackerFactory.open(CrmKioskSurveyLocalService.class);
}