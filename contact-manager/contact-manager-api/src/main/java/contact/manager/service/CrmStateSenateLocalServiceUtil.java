 ...
 * <code>contact.manager.service.impl.CrmStateSenateLocalServiceImpl</code> and
...
public class CrmStateSenateLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmStateSenateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static contact.manager.model.CrmStateSenate
	...
	public static java.util.List<contact.manager.model.CrmStateSenate>
	...
	public static java.util.List<contact.manager.model.CrmStateSenate>
		...
		return getService().getCrmStateSenatesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CrmStateSenateLocalService.class);

		ServiceTracker<CrmStateSenateLocalService, CrmStateSenateLocalService>
			serviceTracker =
				new ServiceTracker
					<CrmStateSenateLocalService, CrmStateSenateLocalService>(
