 ...
 * <code>contact.manager.service.impl.CrmUsRepLocalServiceImpl</code> and
...
public class CrmUsRepLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmUsRepLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static contact.manager.model.CrmUsRep createCrmUsRep(
		long crmUsRepId) {
	...
	public static contact.manager.model.CrmUsRep fetchCrmUsRep(
		long crmUsRepId) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmUsRep>
	...
	public static java.util.List<contact.manager.model.CrmUsRep>
		...
		return getService().getCrmUsRepsByUuidAndCompanyId(
	...
	private static ServiceTracker<CrmUsRepLocalService, CrmUsRepLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmUsRepLocalService.class);

		ServiceTracker<CrmUsRepLocalService, CrmUsRepLocalService>
			serviceTracker =
				new ServiceTracker<CrmUsRepLocalService, CrmUsRepLocalService>(
					bundle.getBundleContext(), CrmUsRepLocalService.class,
					null);
