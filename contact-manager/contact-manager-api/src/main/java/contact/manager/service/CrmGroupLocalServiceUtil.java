 ...
 * <code>contact.manager.service.impl.CrmGroupLocalServiceImpl</code> and
...
public class CrmGroupLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmGroupLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static void addCrmContactCrmGroup(
		long crmContactId, contact.manager.model.CrmGroup crmGroup) {

		getService().addCrmContactCrmGroup(crmContactId, crmGroup);
	}

	public static void addCrmContactCrmGroup(
		long crmContactId, long crmGroupId) {

		getService().addCrmContactCrmGroup(crmContactId, crmGroupId);
	}

	public static void addCrmContactCrmGroups(
		long crmContactId,
	 ...
	 */
	public static contact.manager.model.CrmGroup createCrmGroup(
		long crmGroupId) {

		return getService().createCrmGroup(crmGroupId);
	}

	public static void deleteCrmContactCrmGroup(
		long crmContactId, contact.manager.model.CrmGroup crmGroup) {
	...
	public static void deleteCrmContactCrmGroups(
		long crmContactId,
		java.util.List<contact.manager.model.CrmGroup> crmGroups) {
	...
	public static contact.manager.model.CrmGroup fetchCrmGroup(
		long crmGroupId) {
	...
	public static java.util.List<contact.manager.model.CrmGroup> findAll(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmGroup> orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static java.util.List<contact.manager.model.CrmGroup>
		getCrmContactCrmGroups(long crmContactId) {

		return getService().getCrmContactCrmGroups(crmContactId);
	}

	public static java.util.List<contact.manager.model.CrmGroup>
		getCrmContactCrmGroups(long crmContactId, int start, int end) {

		return getService().getCrmContactCrmGroups(crmContactId, start, end);
	}

	public static java.util.List<contact.manager.model.CrmGroup>
		getCrmContactCrmGroups(
			long crmContactId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmGroup> orderByComparator) {

		return getService().getCrmContactCrmGroups(
	...
	public static java.util.List<contact.manager.model.CrmContact>
		getCrmContacts(long crmGroupId) {

		return getService().getCrmContacts(crmGroupId);
	}

	public static java.util.List<contact.manager.model.CrmContact>
		getCrmContacts(long crmGroupId, int start, int end) {
	...
	public static java.util.List<contact.manager.model.CrmContact>
		...
		return getService().getCrmContacts(
	...
	public static java.util.List<contact.manager.model.CrmGroup>
			getCrmGroupByStatus(String crmGroupStatus)
		throws com.liferay.portal.kernel.exception.SystemException {

		return getService().getCrmGroupByStatus(crmGroupStatus);
	}

	public static java.util.List<contact.manager.model.CrmGroup>
			getCrmGroupByStatus(String crmGroupStatus, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {

		return getService().getCrmGroupByStatus(crmGroupStatus, start, end);
	}
	...
	public static java.util.List<contact.manager.model.CrmGroup>
		...
		return getService().getCrmGroupByStatus(
			crmGroupStatus, start, end, orderByComparator);
	}
	...
	public static java.util.List<contact.manager.model.CrmGroup>
			getCrmGroupsByName(String crmGroupName)
		throws com.liferay.portal.kernel.exception.SystemException {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmGroup>
		getCrmGroupsByUuidAndCompanyId(String uuid, long companyId) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmGroup>
		getCrmGroupsByUuidAndCompanyId(
			String uuid, long companyId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmGroup> orderByComparator) {

		return getService().getCrmGroupsByUuidAndCompanyId(
	...
	public static boolean hasCrmContactCrmGroup(
		long crmContactId, long crmGroupId) {
	...
	public static void setCrmContactCrmGroups(
		long crmContactId, long[] crmGroupIds) {
	...
	private static ServiceTracker<CrmGroupLocalService, CrmGroupLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmGroupLocalService.class);

		ServiceTracker<CrmGroupLocalService, CrmGroupLocalService>
			serviceTracker =
				new ServiceTracker<CrmGroupLocalService, CrmGroupLocalService>(
					bundle.getBundleContext(), CrmGroupLocalService.class,
					null);
