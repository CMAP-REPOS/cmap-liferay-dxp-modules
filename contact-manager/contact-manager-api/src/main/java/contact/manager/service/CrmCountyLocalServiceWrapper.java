 ...
 */
@ProviderType
public class CrmCountyLocalServiceWrapper
	implements CrmCountyLocalService, ServiceWrapper<CrmCountyLocalService> {
	...
	public long dynamicQueryCount(
		...
		return _crmCountyLocalService.dynamicQueryCount(
	...
	public contact.manager.model.CrmCounty fetchCrmCountyByUuidAndGroupId(
		...
		return _crmCountyLocalService.fetchCrmCountyByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	@Override
	public java.util.List<contact.manager.model.CrmCounty>
		getCrmCountiesByUuidAndCompanyId(String uuid, long companyId) {

		return _crmCountyLocalService.getCrmCountiesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public contact.manager.model.CrmCounty getCrmCountyByUuidAndGroupId(
		...
		return _crmCountyLocalService.getCrmCountyByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _crmCountyLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
