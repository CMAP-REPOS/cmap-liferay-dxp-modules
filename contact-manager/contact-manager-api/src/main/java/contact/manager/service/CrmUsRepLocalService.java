...
/**
 * Provides the local service interface for CrmUsRep. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrmUsRepLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CrmUsRepLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmUsRepLocalServiceUtil} to access the CRM US Rep local service. Add custom service methods to <code>contact.manager.service.impl.CrmUsRepLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CrmUsRep addCrmUsRep(CrmUsRep crmUsRep);
	...
	public CrmUsRep deleteCrmUsRep(CrmUsRep crmUsRep);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmUsRep> getCrmUsReps(int start, int end);
