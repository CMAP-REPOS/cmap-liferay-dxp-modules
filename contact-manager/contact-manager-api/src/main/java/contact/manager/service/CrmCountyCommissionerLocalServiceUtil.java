 ...
 * <code>contact.manager.service.impl.CrmCountyCommissionerLocalServiceImpl</code> and
...
public class CrmCountyCommissionerLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmCountyCommissionerLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static contact.manager.model.CrmCountyCommissioner
		addCrmCountyCommissioner(
	 ...
	 */
	public static contact.manager.model.CrmCountyCommissioner
		createCrmCountyCommissioner(long crmCountyCommissionerOrBoardDistId) {

		return getService().createCrmCountyCommissioner(
	 ...
	 */
	public static contact.manager.model.CrmCountyCommissioner
			deleteCrmCountyCommissioner(long crmCountyCommissionerOrBoardDistId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteCrmCountyCommissioner(
			crmCountyCommissionerOrBoardDistId);
	}
	...
	public static contact.manager.model.CrmCountyCommissioner
		fetchCrmCountyCommissioner(long crmCountyCommissionerOrBoardDistId) {

		return getService().fetchCrmCountyCommissioner(
			crmCountyCommissionerOrBoardDistId);
	}
	 ...
	 */
	public static contact.manager.model.CrmCountyCommissioner
		fetchCrmCountyCommissionerByUuidAndGroupId(String uuid, long groupId) {

		return getService().fetchCrmCountyCommissionerByUuidAndGroupId(
			uuid, groupId);
	}

	public static java.util.List<contact.manager.model.CrmCountyCommissioner>
	 ...
	 */
	public static contact.manager.model.CrmCountyCommissioner
			getCrmCountyCommissioner(long crmCountyCommissionerOrBoardDistId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getCrmCountyCommissioner(
			crmCountyCommissionerOrBoardDistId);
	}
	 ...
	 */
	public static contact.manager.model.CrmCountyCommissioner
			getCrmCountyCommissionerByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getCrmCountyCommissionerByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmCountyCommissioner>
		getCrmCountyCommissioners(int start, int end) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmCountyCommissioner>
		getCrmCountyCommissionersByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getCrmCountyCommissionersByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static java.util.List<contact.manager.model.CrmCountyCommissioner>
		getCrmCountyCommissionersByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmCountyCommissioner>
					orderByComparator) {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CrmCountyCommissionerLocalService.class);

		ServiceTracker
			<CrmCountyCommissionerLocalService,
			 CrmCountyCommissionerLocalService> serviceTracker =
				new ServiceTracker
					<CrmCountyCommissionerLocalService,
					 CrmCountyCommissionerLocalService>(
						 bundle.getBundleContext(),
						 CrmCountyCommissionerLocalService.class, null);
