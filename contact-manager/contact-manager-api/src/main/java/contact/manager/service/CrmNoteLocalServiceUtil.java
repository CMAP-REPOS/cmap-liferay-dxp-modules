 ...
 * <code>contact.manager.service.impl.CrmNoteLocalServiceImpl</code> and
...
public class CrmNoteLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmNoteLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static java.util.List<contact.manager.model.CrmNote>
	...
	public static java.util.List<contact.manager.model.CrmNote>
		findByCrmContactId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmNote> orderByComparator) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmNote>
		getCrmNotesByUuidAndCompanyId(String uuid, long companyId) {
	 ...
	 */
	public static java.util.List<contact.manager.model.CrmNote>
		getCrmNotesByUuidAndCompanyId(
			String uuid, long companyId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmNote> orderByComparator) {

		return getService().getCrmNotesByUuidAndCompanyId(
	...
	private static ServiceTracker<CrmNoteLocalService, CrmNoteLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmNoteLocalService.class);

		ServiceTracker<CrmNoteLocalService, CrmNoteLocalService>
			serviceTracker =
				new ServiceTracker<CrmNoteLocalService, CrmNoteLocalService>(
					bundle.getBundleContext(), CrmNoteLocalService.class, null);
