 ...
 */
@ProviderType
public class CrmMuniLocalServiceWrapper
	implements CrmMuniLocalService, ServiceWrapper<CrmMuniLocalService> {
	 ...
	 */
	@Override
	public java.util.List<contact.manager.model.CrmMuni>
		getCrmMunisByUuidAndCompanyId(String uuid, long companyId) {

		return _crmMuniLocalService.getCrmMunisByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _crmMuniLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
