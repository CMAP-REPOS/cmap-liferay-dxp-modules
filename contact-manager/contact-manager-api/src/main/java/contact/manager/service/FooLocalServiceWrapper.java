...
public class FooLocalServiceWrapper implements FooLocalService,
	...
	*/
	@Override
	public contact.manager.model.Foo addFoo(contact.manager.model.Foo foo) {
	...
	*/
	@Override
	public contact.manager.model.Foo createFoo(long fooId) {
	...
	*/
	@Override
	public contact.manager.model.Foo deleteFoo(contact.manager.model.Foo foo) {
	...
	*/
	@Override
	public contact.manager.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _fooLocalService.deleteFoo(fooId);
	}

	@Override
	public contact.manager.model.Foo fetchFoo(long fooId) {
	...
	*/
	@Override
	public contact.manager.model.Foo fetchFooByUuidAndGroupId(
	...
	*/
	@Override
	public contact.manager.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public contact.manager.model.Foo getFooByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public contact.manager.model.Foo updateFoo(contact.manager.model.Foo foo) {
	...
	*/
	@Override
	public java.util.List<contact.manager.model.Foo> getFoos(int start, int end) {
	...
	*/
	@Override
	public java.util.List<contact.manager.model.Foo> getFoosByUuidAndCompanyId(
