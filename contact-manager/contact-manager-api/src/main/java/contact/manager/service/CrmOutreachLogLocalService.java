...
/**
 * Provides the local service interface for CrmOutreachLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CrmOutreachLogLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CrmOutreachLogLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmOutreachLogLocalServiceUtil} to access the CRM Outreach Log local service. Add custom service methods to <code>contact.manager.service.impl.CrmOutreachLogLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CrmOutreachLog deleteCrmOutreachLog(CrmOutreachLog crmOutreachLog);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmOutreachLog> getCrmOutreachLogs(int start, int end);
