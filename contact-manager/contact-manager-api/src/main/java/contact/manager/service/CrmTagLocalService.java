...
public interface CrmTagLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CrmTagLocalServiceUtil} to access the CRM Tag local service. Add custom service methods to <code>contact.manager.service.impl.CrmTagLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public void deleteCrmContactCrmTags(
		long crmContactId, List<CrmTag> crmTags);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmTag> getCrmContactCrmTags(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmTag> getCrmTagsByUuidAndCompanyId(
