...
public interface CrmTagLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrmTag fetchCrmTagByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrmTag getCrmTagByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmTag> getCrmTagsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
