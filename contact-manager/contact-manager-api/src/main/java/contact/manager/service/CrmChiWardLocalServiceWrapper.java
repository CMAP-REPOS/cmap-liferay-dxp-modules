 ...
 */
@ProviderType
public class CrmChiWardLocalServiceWrapper
	implements CrmChiWardLocalService, ServiceWrapper<CrmChiWardLocalService> {
	 ...
	 */
	@Override
	public contact.manager.model.CrmChiWard createCrmChiWard(
		long crmChiWardId) {
	...
	public long dynamicQueryCount(
		...
		return _crmChiWardLocalService.dynamicQueryCount(
	...
	public contact.manager.model.CrmChiWard fetchCrmChiWardByUuidAndGroupId(
		...
		return _crmChiWardLocalService.fetchCrmChiWardByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public contact.manager.model.CrmChiWard getCrmChiWardByUuidAndGroupId(
		...
		return _crmChiWardLocalService.getCrmChiWardByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	@Override
	public java.util.List<contact.manager.model.CrmChiWard>
		getCrmChiWardsByUuidAndCompanyId(String uuid, long companyId) {

		return _crmChiWardLocalService.getCrmChiWardsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _crmChiWardLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
