 ...
 */
@ProviderType
public class CrmNoteLocalServiceWrapper
	implements CrmNoteLocalService, ServiceWrapper<CrmNoteLocalService> {
	...
	public java.util.List<contact.manager.model.CrmNote> findByCrmContactId(
		...
		return _crmNoteLocalService.findByCrmContactId(
	 ...
	 */
	@Override
	public java.util.List<contact.manager.model.CrmNote>
		getCrmNotesByUuidAndCompanyId(String uuid, long companyId) {

		return _crmNoteLocalService.getCrmNotesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _crmNoteLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
