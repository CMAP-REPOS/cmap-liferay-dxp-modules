...
public interface CrmContactLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CrmContact fetchCrmContactByUuidAndGroupId(String uuid, long groupId);

	public CrmContact findByConstantContactId(long constantContactId)
		throws SystemException, NoSuchContactException,
			NoSuchCrmContactException;

	public List<CrmContact> findByPrimaryEmailAddress(
		String primaryEmailAddress) throws SystemException;

	public List<CrmContact> findByPrimaryEmailAddressAndStatus(
		String primaryEmailAddress, String status) throws SystemException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmContact> getCrmContactsByStatus(String status, int start,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CrmContact> getCrmContactsByUuidAndCompanyId(String uuid,
		long companyId);
