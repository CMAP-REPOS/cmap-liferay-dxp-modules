 ...
 * <code>contact.manager.service.impl.CrmContactAuditLogChangeLocalServiceImpl</code> and
...
public class CrmContactAuditLogChangeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmContactAuditLogChangeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static contact.manager.model.CrmContactAuditLogChange
		addCrmContactAuditLogChange(
			contact.manager.model.CrmContactAuditLogChange
				crmContactAuditLogChange) {

		return getService().addCrmContactAuditLogChange(
			crmContactAuditLogChange);
	}
	...
	public static contact.manager.model.CrmContactAuditLogChange
		...
		return getService().createCrmContactAuditLogChange(
	...
	public static contact.manager.model.CrmContactAuditLogChange
		...
		return getService().deleteCrmContactAuditLogChange(
			crmContactAuditLogChange);
	}
	...
	public static contact.manager.model.CrmContactAuditLogChange
		...
		return getService().fetchCrmContactAuditLogChange(
			crmContactAuditLogChangeId);
	}
	...
	public static contact.manager.model.CrmContactAuditLogChange
		...
		return getService().fetchCrmContactAuditLogChangeByUuidAndGroupId(
			uuid, groupId);
	}

	public static java.util.List<contact.manager.model.CrmContactAuditLogChange>
	...
	public static java.util.List<contact.manager.model.CrmContactAuditLogChange>
		...
		return getService().findByCrmContactAuditLogId(
	...
	public static contact.manager.model.CrmContactAuditLogChange
		...
		return getService().getCrmContactAuditLogChange(
			crmContactAuditLogChangeId);
	}
	...
	public static contact.manager.model.CrmContactAuditLogChange
		...
		return getService().getCrmContactAuditLogChangeByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static java.util.List<contact.manager.model.CrmContactAuditLogChange>
		...
		return getService().getCrmContactAuditLogChangesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static contact.manager.model.CrmContactAuditLogChange
		...
		return getService().updateCrmContactAuditLogChange(
			crmContactAuditLogChange);
	}
	...
	private static ServiceTracker
		<CrmContactAuditLogChangeLocalService,
		 CrmContactAuditLogChangeLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CrmContactAuditLogChangeLocalService.class);

		ServiceTracker
			<CrmContactAuditLogChangeLocalService,
			 CrmContactAuditLogChangeLocalService> serviceTracker =
				new ServiceTracker
					<CrmContactAuditLogChangeLocalService,
					 CrmContactAuditLogChangeLocalService>(
