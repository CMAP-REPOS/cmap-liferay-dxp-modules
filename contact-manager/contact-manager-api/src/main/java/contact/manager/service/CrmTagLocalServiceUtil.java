 ...
 * <code>contact.manager.service.impl.CrmTagLocalServiceImpl</code> and
...
public class CrmTagLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>contact.manager.service.impl.CrmTagLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static void addCrmContactCrmTag(
	...
	public static void addCrmContactCrmTags(
		long crmContactId,
	...
	public static void addCrmContactCrmTags(
		long crmContactId, long[] crmTagIds) {
	...
	public static void deleteCrmContactCrmTag(
		long crmContactId, contact.manager.model.CrmTag crmTag) {
	...
	public static void deleteCrmContactCrmTag(
		long crmContactId, long crmTagId) {

		getService().deleteCrmContactCrmTag(crmContactId, crmTagId);
	}

	public static void deleteCrmContactCrmTags(
		long crmContactId,
		java.util.List<contact.manager.model.CrmTag> crmTags) {
	...
	public static java.util.List<contact.manager.model.CrmTag>
		getCrmContactCrmTags(long crmContactId) {

		return getService().getCrmContactCrmTags(crmContactId);
	}

	public static java.util.List<contact.manager.model.CrmTag>
		getCrmContactCrmTags(long crmContactId, int start, int end) {

		return getService().getCrmContactCrmTags(crmContactId, start, end);
	}

	public static java.util.List<contact.manager.model.CrmTag>
		getCrmContactCrmTags(
			long crmContactId, int start, int end,
			com.liferay.portal.kernel.util.OrderByComparator
				<contact.manager.model.CrmTag> orderByComparator) {

		return getService().getCrmContactCrmTags(
	...
	public static java.util.List<contact.manager.model.CrmTag>
		...
		return getService().getCrmTagsByUuidAndCompanyId(
	...
	public static boolean hasCrmContactCrmTag(
		long crmContactId, long crmTagId) {
	...
	public static void setCrmContactCrmTags(
		long crmContactId, long[] crmTagIds) {
	...
	private static ServiceTracker<CrmTagLocalService, CrmTagLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CrmTagLocalService.class);

		ServiceTracker<CrmTagLocalService, CrmTagLocalService> serviceTracker =
			new ServiceTracker<CrmTagLocalService, CrmTagLocalService>(
				bundle.getBundleContext(), CrmTagLocalService.class, null);
