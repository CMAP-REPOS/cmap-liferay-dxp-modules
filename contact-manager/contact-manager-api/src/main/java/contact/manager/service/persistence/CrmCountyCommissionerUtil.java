...
/**
 * The persistence utility for the CRM County Commissioner service. This utility wraps <code>contact.manager.service.persistence.impl.CrmCountyCommissionerPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CrmCountyCommissionerUtil {
	 ...
	 */
	public static Map<Serializable, CrmCountyCommissioner> fetchByPrimaryKeys(
	 ...
	 * @throws NoSuchCrmCountyCommissionerException if a matching CRM County Commissioner could not be found
	 */
	public static CrmCountyCommissioner findByUuid_Last(
			String uuid,
			OrderByComparator<CrmCountyCommissioner> orderByComparator)
		throws contact.manager.exception.NoSuchCrmCountyCommissionerException {
	...
	public static CrmCountyCommissioner[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			crmCountyCommissionerOrBoardDistId, uuid, orderByComparator);
	}
	 ...
	 */
	@Deprecated
	public static CrmCountyCommissioner fetchByUUID_G(
	 ...
	 */
	public static CrmCountyCommissioner removeByUUID_G(
			String uuid, long groupId)
		throws contact.manager.exception.NoSuchCrmCountyCommissionerException {
	...
	public static CrmCountyCommissioner[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			crmCountyCommissionerOrBoardDistId, uuid, companyId,
			orderByComparator);
	}
	...
	public static CrmCountyCommissioner[] findByZipCode_PrevAndNext(
		...
		return getPersistence().findByZipCode_PrevAndNext(
			crmCountyCommissionerOrBoardDistId, zipCode, orderByComparator);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CrmCountyCommissionerPersistence.class);
