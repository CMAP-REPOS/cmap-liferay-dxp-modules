...
/**
 * Provides the local service interface for ExtFormalEducation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExtFormalEducationLocalServiceUtil
...
public interface ExtFormalEducationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExtFormalEducationLocalServiceUtil} to access the ext formal education local service. Add custom service methods to {@link ucc.portal.service.impl.ExtFormalEducationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ExtFormalEducation addExtFormalEducation(
	...
	*/
	...
	public ExtFormalEducation createExtFormalEducation(
	...
	*/
	...
	public ExtFormalEducation deleteExtFormalEducation(
		ExtFormalEducation extFormalEducation);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ExtFormalEducation deleteExtFormalEducation(
		long extFormalEducationId) throws PortalException;
	...
	*/
	...
	public ExtFormalEducation fetchExtFormalEducation(long extFormalEducationId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExtFormalEducation getExtFormalEducation(long extFormalEducationId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ExtFormalEducation> getExtFormalEducations(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ExtFormalEducation updateExtFormalEducation(
		ExtFormalEducation extFormalEducation);
}