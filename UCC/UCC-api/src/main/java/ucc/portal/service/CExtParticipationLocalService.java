...
/**
 * Provides the local service interface for CExtParticipation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CExtParticipationLocalServiceUtil
...
public interface CExtParticipationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CExtParticipationLocalServiceUtil} to access the c ext participation local service. Add custom service methods to {@link ucc.portal.service.impl.CExtParticipationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CExtParticipation addCExtParticipation(
	...
	*/
	...
	public CExtParticipation createCExtParticipation(
	...
	*/
	...
	public CExtParticipation deleteCExtParticipation(
		CExtParticipation cExtParticipation);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CExtParticipation deleteCExtParticipation(
		CExtParticipationPK cExtParticipationPK) throws PortalException;
	...
	*/
	...
	public CExtParticipation fetchCExtParticipation(
		CExtParticipationPK cExtParticipationPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CExtParticipation getCExtParticipation(
		CExtParticipationPK cExtParticipationPK) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CExtParticipation> getCExtParticipations(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CExtParticipation updateCExtParticipation(
		CExtParticipation cExtParticipation);
}