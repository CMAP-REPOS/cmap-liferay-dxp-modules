...
/**
 * Provides the local service interface for ExtReference. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExtReferenceLocalServiceUtil
...
public interface ExtReferenceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExtReferenceLocalServiceUtil} to access the ext reference local service. Add custom service methods to {@link ucc.portal.service.impl.ExtReferenceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ExtReference addExtReference(ExtReference extReference);
	...
	*/
	...
	public ExtReference createExtReference(long extReferenceId);
	...
	*/
	...
	public ExtReference deleteExtReference(ExtReference extReference);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ExtReference deleteExtReference(long extReferenceId)
	...
	*/
	...
	public ExtReference fetchExtReference(long extReferenceId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExtReference getExtReference(long extReferenceId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ExtReference> getExtReferences(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ExtReference updateExtReference(ExtReference extReference);
}