...
/**
 * Provides the local service interface for CExtOrganization. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CExtOrganizationLocalServiceUtil
...
public interface CExtOrganizationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CExtOrganizationLocalServiceUtil} to access the c ext organization local service. Add custom service methods to {@link ucc.portal.service.impl.CExtOrganizationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CExtOrganization addCExtOrganization(
		CExtOrganization cExtOrganization);
	...
	*/
	...
	public CExtOrganization createCExtOrganization(long organizationId);
	...
	*/
	...
	public CExtOrganization deleteCExtOrganization(
		CExtOrganization cExtOrganization);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CExtOrganization deleteCExtOrganization(long organizationId)
	...
	*/
	...
	public CExtOrganization fetchCExtOrganization(long organizationId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CExtOrganization getCExtOrganization(long organizationId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CExtOrganization> getCExtOrganizations(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CExtOrganization updateCExtOrganization(
		CExtOrganization cExtOrganization);
}