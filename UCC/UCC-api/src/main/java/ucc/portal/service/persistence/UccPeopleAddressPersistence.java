...
/**
 * The persistence interface for the ucc people address service.
 *
 * <p>
 ...
 * @see UccPeopleAddressUtil
 * @generated
 */
@ProviderType
public interface UccPeopleAddressPersistence extends BasePersistence<UccPeopleAddress> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UccPeopleAddressUtil} to access the ucc people address persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<UccPeopleAddress> findByP_T_A(int uccPeopleId,
	...
	*/
	public java.util.List<UccPeopleAddress> findByP_T_A(int uccPeopleId,
		String type, boolean myActive, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<UccPeopleAddress> orderByComparator);
	...
	*/
	public void cacheResult(java.util.List<UccPeopleAddress> uccPeopleAddresses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, UccPeopleAddress> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<UccPeopleAddress> findAll();
	...
	*/
	public java.util.List<UccPeopleAddress> findAll(int start, int end);
