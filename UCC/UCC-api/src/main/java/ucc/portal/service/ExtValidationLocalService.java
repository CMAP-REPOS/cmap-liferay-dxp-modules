...
/**
 * Provides the local service interface for ExtValidation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExtValidationLocalServiceUtil
...
public interface ExtValidationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExtValidationLocalServiceUtil} to access the ext validation local service. Add custom service methods to {@link ucc.portal.service.impl.ExtValidationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ExtValidation addExtValidation(ExtValidation extValidation);
	...
	*/
	...
	public ExtValidation createExtValidation(long extValidationId);
	...
	*/
	...
	public ExtValidation deleteExtValidation(ExtValidation extValidation);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ExtValidation deleteExtValidation(long extValidationId)
	...
	*/
	...
	public ExtValidation fetchExtValidation(long extValidationId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExtValidation getExtValidation(long extValidationId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ExtValidation> getExtValidations(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ExtValidation updateExtValidation(ExtValidation extValidation);
}