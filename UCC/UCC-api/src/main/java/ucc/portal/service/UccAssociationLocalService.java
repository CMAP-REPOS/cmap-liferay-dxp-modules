...
/**
 * Provides the local service interface for UccAssociation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UccAssociationLocalServiceUtil
...
public interface UccAssociationLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UccAssociationLocalServiceUtil} to access the ucc association local service. Add custom service methods to {@link ucc.portal.service.impl.UccAssociationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public UccAssociation addUccAssociation(UccAssociation uccAssociation);
	...
	*/
	...
	public UccAssociation createUccAssociation(int uccAssociationId);
	...
	*/
	...
	public UccAssociation deleteUccAssociation(int uccAssociationId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public UccAssociation deleteUccAssociation(UccAssociation uccAssociation);
	...
	*/
	...
	public UccAssociation fetchUccAssociation(int uccAssociationId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UccAssociation getUccAssociation(int uccAssociationId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UccAssociation> getUccAssociations(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public UccAssociation updateUccAssociation(UccAssociation uccAssociation);
}