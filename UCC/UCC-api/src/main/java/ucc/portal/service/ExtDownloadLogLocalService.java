...
/**
 * Provides the local service interface for ExtDownloadLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExtDownloadLogLocalServiceUtil
...
public interface ExtDownloadLogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExtDownloadLogLocalServiceUtil} to access the ext download log local service. Add custom service methods to {@link ucc.portal.service.impl.ExtDownloadLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ExtDownloadLog addExtDownloadLog(ExtDownloadLog extDownloadLog);
	...
	*/
	...
	public ExtDownloadLog createExtDownloadLog(long extDownloadLogId);
	...
	*/
	...
	public ExtDownloadLog deleteExtDownloadLog(ExtDownloadLog extDownloadLog);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ExtDownloadLog deleteExtDownloadLog(long extDownloadLogId)
	...
	*/
	...
	public ExtDownloadLog fetchExtDownloadLog(long extDownloadLogId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExtDownloadLog getExtDownloadLog(long extDownloadLogId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ExtDownloadLog> getExtDownloadLogs(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ExtDownloadLog updateExtDownloadLog(ExtDownloadLog extDownloadLog);
}