...
import contact.manager.service.service.CmapSubGroupLocalService;
...
/**
 * Provides the base implementation for the cmap sub group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link contact.manager.service.service.impl.CmapSubGroupLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class CmapSubGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CmapSubGroupLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.service.CmapSubGroupLocalServiceUtil} to access the cmap sub group local service.
	 */
	...
	public CmapSubGroup addCmapSubGroup(CmapSubGroup cmapSubGroup) {
		...
		return cmapSubGroupPersistence.update(cmapSubGroup);
	}
	...
	public CmapSubGroup createCmapSubGroup(long subGroupId) {
		return cmapSubGroupPersistence.create(subGroupId);
	}
	...
	public CmapSubGroup deleteCmapSubGroup(long subGroupId)
		...
		return cmapSubGroupPersistence.remove(subGroupId);
	}
	...
	public CmapSubGroup deleteCmapSubGroup(CmapSubGroup cmapSubGroup) {
		return cmapSubGroupPersistence.remove(cmapSubGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CmapSubGroup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cmapSubGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cmapSubGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CmapSubGroup fetchCmapSubGroup(long subGroupId) {
		return cmapSubGroupPersistence.fetchByPrimaryKey(subGroupId);
	}
	...
	public CmapSubGroup getCmapSubGroup(long subGroupId)
		throws PortalException {
		return cmapSubGroupPersistence.findByPrimaryKey(subGroupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cmapSubGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CmapSubGroup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("subGroupId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cmapSubGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CmapSubGroup.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("subGroupId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cmapSubGroupLocalService.deleteCmapSubGroup((CmapSubGroup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cmapSubGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CmapSubGroup> getCmapSubGroups(int start, int end) {
		return cmapSubGroupPersistence.findAll(start, end);
	}
	...
	public int getCmapSubGroupsCount() {
		return cmapSubGroupPersistence.countAll();
	}
	...
	public void addContactCmapSubGroup(long contactId, long subGroupId) {
		contactPersistence.addCmapSubGroup(contactId, subGroupId);
	}
	...
	public void addContactCmapSubGroup(long contactId, CmapSubGroup cmapSubGroup) {
		contactPersistence.addCmapSubGroup(contactId, cmapSubGroup);
	}
	...
	public void addContactCmapSubGroups(long contactId, long[] subGroupIds) {
		contactPersistence.addCmapSubGroups(contactId, subGroupIds);
	}
	...
	public void addContactCmapSubGroups(long contactId,
		...
		contactPersistence.addCmapSubGroups(contactId, cmapSubGroups);
	}
	...
	public void clearContactCmapSubGroups(long contactId) {
		contactPersistence.clearCmapSubGroups(contactId);
	}
	...
	public void deleteContactCmapSubGroup(long contactId, long subGroupId) {
		contactPersistence.removeCmapSubGroup(contactId, subGroupId);
	}
	...
	public void deleteContactCmapSubGroup(long contactId,
		...
		contactPersistence.removeCmapSubGroup(contactId, cmapSubGroup);
	}
	...
	public void deleteContactCmapSubGroups(long contactId, long[] subGroupIds) {
		contactPersistence.removeCmapSubGroups(contactId, subGroupIds);
	}
	...
	public void deleteContactCmapSubGroups(long contactId,
		List<CmapSubGroup> cmapSubGroups) {
		contactPersistence.removeCmapSubGroups(contactId, cmapSubGroups);
	}
	...
	public long[] getContactPrimaryKeys(long subGroupId) {
		return cmapSubGroupPersistence.getContactPrimaryKeys(subGroupId);
	}
	...
	public List<CmapSubGroup> getContactCmapSubGroups(long contactId) {
		return contactPersistence.getCmapSubGroups(contactId);
	}
	...
	public List<CmapSubGroup> getContactCmapSubGroups(long contactId,
		int start, int end) {
		return contactPersistence.getCmapSubGroups(contactId, start, end);
	}
	...
	public int getContactCmapSubGroupsCount(long contactId) {
		return contactPersistence.getCmapSubGroupsSize(contactId);
	}
	...
	public boolean hasContactCmapSubGroup(long contactId, long subGroupId) {
		return contactPersistence.containsCmapSubGroup(contactId, subGroupId);
	}
	...
	public boolean hasContactCmapSubGroups(long contactId) {
		return contactPersistence.containsCmapSubGroups(contactId);
	}
	...
	public void setContactCmapSubGroups(long contactId, long[] subGroupIds) {
		contactPersistence.setCmapSubGroups(contactId, subGroupIds);
	}
	 ...
	 */
	public CmapSubGroupLocalService getCmapSubGroupLocalService() {
	 ...
	 */
	public contact.manager.service.service.ContactAuditLogChangeLocalService getContactAuditLogChangeLocalService() {
	...
	public void setContactAuditLogChangeLocalService(
		contact.manager.service.service.ContactAuditLogChangeLocalService contactAuditLogChangeLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("contact.manager.service.model.CmapSubGroup",
			cmapSubGroupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"contact.manager.service.model.CmapSubGroup");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CmapSubGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cmapSubGroupPersistence.getDataSource();
	...
	@BeanReference(type = CmapSubGroupLocalService.class)
	protected CmapSubGroupLocalService cmapSubGroupLocalService;
	...
	@BeanReference(type = contact.manager.service.service.ContactAuditLogChangeLocalService.class)
	protected contact.manager.service.service.ContactAuditLogChangeLocalService contactAuditLogChangeLocalService;
