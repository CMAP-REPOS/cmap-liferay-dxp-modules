...
import contact.manager.service.service.CmapGroupLocalService;
...
/**
 * Provides the base implementation for the cmap group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link contact.manager.service.service.impl.CmapGroupLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class CmapGroupLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CmapGroupLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.service.CmapGroupLocalServiceUtil} to access the cmap group local service.
	 */
	...
	public CmapGroup addCmapGroup(CmapGroup cmapGroup) {
		...
		return cmapGroupPersistence.update(cmapGroup);
	}
	...
	public CmapGroup createCmapGroup(long groupId) {
		return cmapGroupPersistence.create(groupId);
	}
	...
	public CmapGroup deleteCmapGroup(long groupId) throws PortalException {
		return cmapGroupPersistence.remove(groupId);
	}
	...
	public CmapGroup deleteCmapGroup(CmapGroup cmapGroup) {
		return cmapGroupPersistence.remove(cmapGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CmapGroup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cmapGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return cmapGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cmapGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CmapGroup fetchCmapGroup(long groupId) {
		return cmapGroupPersistence.fetchByPrimaryKey(groupId);
	}
	...
	public CmapGroup getCmapGroup(long groupId) throws PortalException {
		return cmapGroupPersistence.findByPrimaryKey(groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cmapGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CmapGroup.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cmapGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CmapGroup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cmapGroupLocalService.deleteCmapGroup((CmapGroup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cmapGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CmapGroup> getCmapGroups(int start, int end) {
		return cmapGroupPersistence.findAll(start, end);
	}
	...
	public int getCmapGroupsCount() {
		return cmapGroupPersistence.countAll();
	}
	 ...
	 */
	public CmapGroupLocalService getCmapGroupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("contact.manager.service.model.CmapGroup",
			cmapGroupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"contact.manager.service.model.CmapGroup");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CmapGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cmapGroupPersistence.getDataSource();
	...
	@BeanReference(type = CmapGroupLocalService.class)
	protected CmapGroupLocalService cmapGroupLocalService;
