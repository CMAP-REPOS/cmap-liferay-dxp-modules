...
import contact.manager.service.service.State_RepLocalService;
...
/**
 * Provides the base implementation for the state_ rep local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link contact.manager.service.service.impl.State_RepLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class State_RepLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements State_RepLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.service.State_RepLocalServiceUtil} to access the state_ rep local service.
	 */
	...
	public State_Rep addState_Rep(State_Rep state_Rep) {
		...
		return state_RepPersistence.update(state_Rep);
	}
	...
	public State_Rep createState_Rep(long stateRepId) {
		return state_RepPersistence.create(stateRepId);
	}
	...
	public State_Rep deleteState_Rep(long stateRepId) throws PortalException {
		return state_RepPersistence.remove(stateRepId);
	}
	...
	public State_Rep deleteState_Rep(State_Rep state_Rep) {
		return state_RepPersistence.remove(state_Rep);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(State_Rep.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return state_RepPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return state_RepPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return state_RepPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public State_Rep fetchState_Rep(long stateRepId) {
		return state_RepPersistence.fetchByPrimaryKey(stateRepId);
	}
	...
	public State_Rep getState_Rep(long stateRepId) throws PortalException {
		return state_RepPersistence.findByPrimaryKey(stateRepId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(state_RepLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(State_Rep.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("stateRepId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(state_RepLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(State_Rep.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("stateRepId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return state_RepLocalService.deleteState_Rep((State_Rep)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return state_RepPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<State_Rep> getState_Reps(int start, int end) {
		return state_RepPersistence.findAll(start, end);
	}
	...
	public int getState_RepsCount() {
		return state_RepPersistence.countAll();
	}
	 ...
	 */
	public State_RepLocalService getState_RepLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("contact.manager.service.model.State_Rep",
			state_RepLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"contact.manager.service.model.State_Rep");
	}
	...
	public String getOSGiServiceIdentifier() {
		return State_RepLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = state_RepPersistence.getDataSource();
	...
	@BeanReference(type = State_RepLocalService.class)
	protected State_RepLocalService state_RepLocalService;
