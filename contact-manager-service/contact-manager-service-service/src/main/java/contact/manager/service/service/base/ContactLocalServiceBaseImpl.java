...
import contact.manager.service.service.ContactLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link contact.manager.service.service.impl.ContactLocalServiceImpl}.
 * </p>
 *
...
public abstract class ContactLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link contact.manager.service.service.ContactLocalServiceUtil} to access the contact local service.
	 */
	...
	public void addCmapTagContact(long tagId, long contactId) {
		cmapTagPersistence.addContact(tagId, contactId);
	}
	...
	public void addCmapTagContact(long tagId, Contact contact) {
		cmapTagPersistence.addContact(tagId, contact);
	}
	...
	public void addCmapTagContacts(long tagId, long[] contactIds) {
		cmapTagPersistence.addContacts(tagId, contactIds);
	}
	...
	public void addCmapTagContacts(long tagId, List<Contact> contacts) {
		cmapTagPersistence.addContacts(tagId, contacts);
	}
	...
	public void clearCmapTagContacts(long tagId) {
		cmapTagPersistence.clearContacts(tagId);
	}
	...
	public void deleteCmapTagContact(long tagId, long contactId) {
		cmapTagPersistence.removeContact(tagId, contactId);
	}
	...
	public void deleteCmapTagContact(long tagId, Contact contact) {
		cmapTagPersistence.removeContact(tagId, contact);
	}
	...
	public void deleteCmapTagContacts(long tagId, long[] contactIds) {
		cmapTagPersistence.removeContacts(tagId, contactIds);
	}
	...
	public void deleteCmapTagContacts(long tagId, List<Contact> contacts) {
		cmapTagPersistence.removeContacts(tagId, contacts);
	}
	...
	public long[] getCmapTagPrimaryKeys(long contactId) {
		return contactPersistence.getCmapTagPrimaryKeys(contactId);
	}
	...
	public List<Contact> getCmapTagContacts(long tagId) {
		return cmapTagPersistence.getContacts(tagId);
	}
	...
	public List<Contact> getCmapTagContacts(long tagId, int start, int end) {
		return cmapTagPersistence.getContacts(tagId, start, end);
	}
	...
	public int getCmapTagContactsCount(long tagId) {
		return cmapTagPersistence.getContactsSize(tagId);
	}
	...
	public boolean hasCmapTagContact(long tagId, long contactId) {
		return cmapTagPersistence.containsContact(tagId, contactId);
	}
	...
	public boolean hasCmapTagContacts(long tagId) {
		return cmapTagPersistence.containsContacts(tagId);
	}
	...
	public void setCmapTagContacts(long tagId, long[] contactIds) {
		cmapTagPersistence.setContacts(tagId, contactIds);
	}
	...
	public void addCmapSubGroupContact(long subGroupId, long contactId) {
		cmapSubGroupPersistence.addContact(subGroupId, contactId);
	}
	...
	public void addCmapSubGroupContact(long subGroupId, Contact contact) {
		cmapSubGroupPersistence.addContact(subGroupId, contact);
	}
	...
	public void addCmapSubGroupContacts(long subGroupId, long[] contactIds) {
		cmapSubGroupPersistence.addContacts(subGroupId, contactIds);
	}
	...
	public void addCmapSubGroupContacts(long subGroupId, List<Contact> contacts) {
		cmapSubGroupPersistence.addContacts(subGroupId, contacts);
	}
	...
	public void clearCmapSubGroupContacts(long subGroupId) {
		cmapSubGroupPersistence.clearContacts(subGroupId);
	}
	...
	public void deleteCmapSubGroupContact(long subGroupId, long contactId) {
		cmapSubGroupPersistence.removeContact(subGroupId, contactId);
	}
	...
	public void deleteCmapSubGroupContact(long subGroupId, Contact contact) {
		cmapSubGroupPersistence.removeContact(subGroupId, contact);
	}
	...
	public void deleteCmapSubGroupContacts(long subGroupId, long[] contactIds) {
		cmapSubGroupPersistence.removeContacts(subGroupId, contactIds);
	}
	...
	public void deleteCmapSubGroupContacts(long subGroupId,
		...
		cmapSubGroupPersistence.removeContacts(subGroupId, contacts);
	}
	...
	public long[] getCmapSubGroupPrimaryKeys(long contactId) {
		return contactPersistence.getCmapSubGroupPrimaryKeys(contactId);
	}
	...
	public List<Contact> getCmapSubGroupContacts(long subGroupId) {
		return cmapSubGroupPersistence.getContacts(subGroupId);
	}
	...
	public List<Contact> getCmapSubGroupContacts(long subGroupId, int start,
		int end) {
		return cmapSubGroupPersistence.getContacts(subGroupId, start, end);
	}
	...
	public int getCmapSubGroupContactsCount(long subGroupId) {
		return cmapSubGroupPersistence.getContactsSize(subGroupId);
	}
	...
	public boolean hasCmapSubGroupContact(long subGroupId, long contactId) {
		return cmapSubGroupPersistence.containsContact(subGroupId, contactId);
	}
	...
	public boolean hasCmapSubGroupContacts(long subGroupId) {
		return cmapSubGroupPersistence.containsContacts(subGroupId);
	}
	...
	public void setCmapSubGroupContacts(long subGroupId, long[] contactIds) {
		cmapSubGroupPersistence.setContacts(subGroupId, contactIds);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("contact.manager.service.model.Contact",
			contactLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"contact.manager.service.model.Contact");
	}
