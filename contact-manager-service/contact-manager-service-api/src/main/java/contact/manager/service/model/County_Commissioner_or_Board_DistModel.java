...
/**
 * The base model interface for the County_Commissioner_or_Board_Dist service. Represents a row in the &quot;contactmanager_County_Commissioner_or_Board_Dist&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link contact.manager.service.model.impl.County_Commissioner_or_Board_DistModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link contact.manager.service.model.impl.County_Commissioner_or_Board_DistImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface County_Commissioner_or_Board_DistModel extends BaseModel<County_Commissioner_or_Board_Dist> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a county_ commissioner_or_ board_ dist model instance should use the {@link County_Commissioner_or_Board_Dist} interface instead.
	 */
	...
	@Override
	public CacheModel<contact.manager.service.model.County_Commissioner_or_Board_Dist> toCacheModel();
