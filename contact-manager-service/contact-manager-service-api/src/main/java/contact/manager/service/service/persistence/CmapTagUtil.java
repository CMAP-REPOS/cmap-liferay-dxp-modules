...
/**
 * The persistence utility for the cmap tag service. This utility wraps {@link contact.manager.service.service.persistence.impl.CmapTagPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CmapTagUtil {
	 ...
	 */
	public static void clearCache(CmapTag cmapTag) {
		getPersistence().clearCache(cmapTag);
	}
	 ...
	 */
	public static List<CmapTag> findWithDynamicQuery(DynamicQuery dynamicQuery) {
	 ...
	 */
	public static List<CmapTag> findWithDynamicQuery(
	 ...
	 */
	public static CmapTag update(CmapTag cmapTag) {
		return getPersistence().update(cmapTag);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static CmapTag update(CmapTag cmapTag, ServiceContext serviceContext) {
		return getPersistence().update(cmapTag, serviceContext);
	}
	...
	*/
	public static void cacheResult(CmapTag cmapTag) {
		getPersistence().cacheResult(cmapTag);
	}
	...
	*/
	public static void cacheResult(List<CmapTag> cmapTags) {
		getPersistence().cacheResult(cmapTags);
	}
	...
	*/
	public static CmapTag create(long tagId) {
	...
	*/
	public static CmapTag remove(long tagId)
		throws contact.manager.service.exception.NoSuchCmapTagException {
		return getPersistence().remove(tagId);
	}

	public static CmapTag updateImpl(CmapTag cmapTag) {
		return getPersistence().updateImpl(cmapTag);
	}
	...
	* @throws NoSuchCmapTagException if a cmap tag with the primary key could not be found
	*/
	public static CmapTag findByPrimaryKey(long tagId)
		throws contact.manager.service.exception.NoSuchCmapTagException {
	...
	*/
	public static CmapTag fetchByPrimaryKey(long tagId) {
		return getPersistence().fetchByPrimaryKey(tagId);
	}

	public static java.util.Map<java.io.Serializable, CmapTag> fetchByPrimaryKeys(
	...
	*/
	public static List<CmapTag> findAll() {
	...
	*/
	public static List<CmapTag> findAll(int start, int end) {
	...
	*/
	...
	public static CmapTagPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<CmapTagPersistence, CmapTagPersistence> _serviceTracker =
		ServiceTrackerFactory.open(CmapTagPersistence.class);
}