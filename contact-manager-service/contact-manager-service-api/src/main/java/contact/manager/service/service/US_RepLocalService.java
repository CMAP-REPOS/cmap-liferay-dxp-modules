...
/**
 * Provides the local service interface for US_Rep. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see US_RepLocalServiceUtil
...
public interface US_RepLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link US_RepLocalServiceUtil} to access the us_ rep local service. Add custom service methods to {@link contact.manager.service.service.impl.US_RepLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public US_Rep addUS_Rep(US_Rep us_Rep);
	...
	*/
	public US_Rep createUS_Rep(long usRepId);
	...
	*/
	...
	public US_Rep deleteUS_Rep(US_Rep us_Rep);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public US_Rep deleteUS_Rep(long usRepId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public US_Rep fetchUS_Rep(long usRepId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public US_Rep getUS_Rep(long usRepId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public US_Rep updateUS_Rep(US_Rep us_Rep);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<US_Rep> getUS_Reps(int start, int end);
