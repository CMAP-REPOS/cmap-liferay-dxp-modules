...
/**
 * Provides the local service interface for LTA. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LTALocalServiceUtil
...
public interface LTALocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LTALocalServiceUtil} to access the lta local service. Add custom service methods to {@link contact.manager.service.service.impl.LTALocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new lta
	*/
	public LTA createLTA(long ltaId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public LTA deleteLTA(long ltaId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LTA fetchLTA(long ltaId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LTA getLTA(long ltaId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LTA> getLTAs(int start, int end);
