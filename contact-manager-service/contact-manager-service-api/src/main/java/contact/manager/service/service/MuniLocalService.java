...
/**
 * Provides the local service interface for Muni. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MuniLocalServiceUtil
...
public interface MuniLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MuniLocalServiceUtil} to access the muni local service. Add custom service methods to {@link contact.manager.service.service.impl.MuniLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new muni
	*/
	public Muni createMuni(long muniId);
	...
	*/
	...
	public Muni deleteMuni(Muni muni);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Muni deleteMuni(long muniId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Muni fetchMuni(long muniId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Muni getMuni(long muniId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Muni updateMuni(Muni muni);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Muni> getMunis(int start, int end);
