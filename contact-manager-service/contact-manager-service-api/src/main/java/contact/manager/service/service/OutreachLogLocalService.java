...
/**
 * Provides the local service interface for OutreachLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OutreachLogLocalServiceUtil
...
public interface OutreachLogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OutreachLogLocalServiceUtil} to access the outreach log local service. Add custom service methods to {@link contact.manager.service.service.impl.OutreachLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OutreachLog addOutreachLog(OutreachLog outreachLog);
	...
	*/
	public OutreachLog createOutreachLog(long id);
	...
	*/
	...
	public OutreachLog deleteOutreachLog(OutreachLog outreachLog);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OutreachLog deleteOutreachLog(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OutreachLog fetchOutreachLog(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OutreachLog getOutreachLog(long id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OutreachLog updateOutreachLog(OutreachLog outreachLog);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OutreachLog> getOutreachLogs(int start, int end);
