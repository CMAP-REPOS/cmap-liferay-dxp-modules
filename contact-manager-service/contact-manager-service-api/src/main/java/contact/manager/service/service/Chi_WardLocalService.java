...
/**
 * Provides the local service interface for Chi_Ward. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Chi_WardLocalServiceUtil
...
public interface Chi_WardLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Chi_WardLocalServiceUtil} to access the chi_ ward local service. Add custom service methods to {@link contact.manager.service.service.impl.Chi_WardLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Chi_Ward addChi_Ward(Chi_Ward chi_Ward);
	...
	*/
	public Chi_Ward createChi_Ward(long chiWardId);
	...
	*/
	...
	public Chi_Ward deleteChi_Ward(Chi_Ward chi_Ward);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Chi_Ward deleteChi_Ward(long chiWardId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Chi_Ward fetchChi_Ward(long chiWardId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Chi_Ward getChi_Ward(long chiWardId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public Chi_Ward updateChi_Ward(Chi_Ward chi_Ward);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Chi_Ward> getChi_Wards(int start, int end);
