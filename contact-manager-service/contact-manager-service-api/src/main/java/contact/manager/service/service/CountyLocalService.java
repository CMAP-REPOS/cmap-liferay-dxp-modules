...
/**
 * Provides the local service interface for County. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CountyLocalServiceUtil
 * @see contact.manager.service.service.base.CountyLocalServiceBaseImpl
 * @see contact.manager.service.service.impl.CountyLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface CountyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CountyLocalServiceUtil} to access the county local service. Add custom service methods to {@link contact.manager.service.service.impl.CountyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public County createCounty(long countyId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public County deleteCounty(long countyId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public County fetchCounty(long countyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public County getCounty(long countyId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<County> getCounties(int start, int end);
