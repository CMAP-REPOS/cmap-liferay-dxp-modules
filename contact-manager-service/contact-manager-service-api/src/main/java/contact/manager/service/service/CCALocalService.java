...
/**
 * Provides the local service interface for CCA. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CCALocalServiceUtil
 * @see contact.manager.service.service.base.CCALocalServiceBaseImpl
 * @see contact.manager.service.service.impl.CCALocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface CCALocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CCALocalServiceUtil} to access the cca local service. Add custom service methods to {@link contact.manager.service.service.impl.CCALocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new cca
	*/
	public CCA createCCA(long ccaId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CCA deleteCCA(long ccaId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CCA fetchCCA(long ccaId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CCA getCCA(long ccaId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CCA> getCCAs(int start, int end);
