...
/**
 * Provides the local service interface for State_Senate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see State_SenateLocalServiceUtil
...
public interface State_SenateLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link State_SenateLocalServiceUtil} to access the state_ senate local service. Add custom service methods to {@link contact.manager.service.service.impl.State_SenateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public State_Senate addState_Senate(State_Senate state_Senate);
	...
	*/
	public State_Senate createState_Senate(long stateSenateId);
	...
	*/
	...
	public State_Senate deleteState_Senate(State_Senate state_Senate);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public State_Senate deleteState_Senate(long stateSenateId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public State_Senate fetchState_Senate(long stateSenateId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public State_Senate getState_Senate(long stateSenateId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public State_Senate updateState_Senate(State_Senate state_Senate);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<State_Senate> getState_Senates(int start, int end);
