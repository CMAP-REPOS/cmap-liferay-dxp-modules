...
/**
 * Provides the local service interface for State_Rep. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see State_RepLocalServiceUtil
...
public interface State_RepLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link State_RepLocalServiceUtil} to access the state_ rep local service. Add custom service methods to {@link contact.manager.service.service.impl.State_RepLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public State_Rep addState_Rep(State_Rep state_Rep);
	...
	*/
	public State_Rep createState_Rep(long stateRepId);
	...
	*/
	...
	public State_Rep deleteState_Rep(State_Rep state_Rep);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public State_Rep deleteState_Rep(long stateRepId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public State_Rep fetchState_Rep(long stateRepId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public State_Rep getState_Rep(long stateRepId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public State_Rep updateState_Rep(State_Rep state_Rep);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<State_Rep> getState_Reps(int start, int end);
