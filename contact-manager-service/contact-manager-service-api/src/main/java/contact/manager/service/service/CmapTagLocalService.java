...
/**
 * Provides the local service interface for CmapTag. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CmapTagLocalServiceUtil
...
public interface CmapTagLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CmapTagLocalServiceUtil} to access the cmap tag local service. Add custom service methods to {@link contact.manager.service.service.impl.CmapTagLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CmapTag addCmapTag(CmapTag cmapTag);
	...
	*/
	public CmapTag createCmapTag(long tagId);
	...
	*/
	...
	public CmapTag deleteCmapTag(CmapTag cmapTag);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CmapTag deleteCmapTag(long tagId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CmapTag fetchCmapTag(long tagId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CmapTag getCmapTag(long tagId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CmapTag updateCmapTag(CmapTag cmapTag);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CmapTag> getCmapTags(int start, int end);
