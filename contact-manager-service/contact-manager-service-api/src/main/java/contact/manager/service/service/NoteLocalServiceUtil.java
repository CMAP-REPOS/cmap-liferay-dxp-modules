 ...
 * {@link contact.manager.service.service.impl.NoteLocalServiceImpl} and is the
 ...
 * @see contact.manager.service.service.base.NoteLocalServiceBaseImpl
 * @see contact.manager.service.service.impl.NoteLocalServiceImpl
 * @generated
 */
@ProviderType
public class NoteLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link contact.manager.service.service.impl.NoteLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static contact.manager.service.model.Note addNote(
	...
	* @return the new note
	*/
	public static contact.manager.service.model.Note createNote(long id) {
	...
	*/
	public static contact.manager.service.model.Note deleteNote(
		contact.manager.service.model.Note note) {
	...
	*/
	public static contact.manager.service.model.Note deleteNote(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteNote(id);
	}

	public static contact.manager.service.model.Note fetchNote(long id) {
	...
	* @throws PortalException if a note with the primary key could not be found
	*/
	public static contact.manager.service.model.Note getNote(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static contact.manager.service.model.Note updateNote(
		contact.manager.service.model.Note note) {
	...
	*/
	public static java.util.List<contact.manager.service.model.Note> getNotes(
		int start, int end) {
